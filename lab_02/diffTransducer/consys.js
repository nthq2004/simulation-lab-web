...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            { Class: DCPower, id: 'dcpower', x: 20, y: 65 },
            { Class: VariResistor, id: 'varires', x: 350, y: 165,value:500,cvalue:250 },
            { Class: DiffTransmitter, id: 'difftr', x: 230, y: 230 },
            { Class: ThreeValve, id: '3valve', x: 230, y: 480 },
            { Class: TeeConnector, id: 'teeconnector', x: 750, y: 505, direction: 'right' },
            { Class: PressRegulator, id: 'pressreg', x: 500, y: 435 },
            { Class: PressRegulator, id: 'pressreg2', x: 500, y: 635 },
            { Class: StopValve, id: 'stopvalve', x: 900, y: 455 },
            { Class: AirBottle, id: 'cab', x: 1150, y: 435 },

            { Class: Oscilloscope_tri, id: 'osc3', x: 510, y: 300, visible: false },
            { Class: SignalGenerator, id: 'sg', x: 510, y: 300, visible: false },
            { Class: Multimeter, id: 'multimeter', x: 700, y: 10, visible: false },
            { Class: AmpMeter, id: 'ampmeter', x: 80, y: 500, visible: true },
