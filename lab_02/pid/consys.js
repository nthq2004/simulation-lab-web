...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            { Class: DCPower, id: 'dcpower', x: 1250, y: 165 },
            { Class: AmpMeter, id: 'ampmeter2', x: 650, y: 550 },
            { Class: PIDController, id: 'pid', x: 700, y: 50 },
            { Class: ElecValve, id: 'valve', x: 450, y: 700 },
            { Class: TempTransmitter, id: 'temptr', x: 200, y: 165 },
            { Class: VariResistor, id: 'varires', x: 250, y: 450 },
            ...
            { Class: AmpMeter, id: 'ampmeter', x: 480, y: 100, visible: true },
