...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            { Class: PressRelay, id: 'yt1226', x: 20, y: 135 },
            { Class: PressMeter, id: 'pressmeter', x: 550, y: 480 },
            { Class: TeeConnector, id: 'teeconnector', x: 450, y: 665 },
            { Class: PressRegulator, id: 'pressreg', x: 650, y: 635 },
            { Class: StopValve, id: 'stopvalve', x: 950, y: 635 },
            ...
            { Class: Multimeter, id: 'multimeter', x: 700, y: 30, visible: true },
            { Class: AmpMeter, id: 'ampmeter', x: 80, y: 500, visible: false },
