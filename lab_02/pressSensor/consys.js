...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            ...
            { Class: VariResistor, id: 'varires', x: 320, y: 130 ,value:500,cvalue:250},
            { Class: PressTransmitter, id: 'ptr', x: 300, y: 230 },

            { Class: AirBottle, id: 'cab', x: 950, y: 530 },
            { Class: StopValve, id: 'stopvalve', x: 720, y: 630 },
            { Class: PressRegulator, id: 'pressreg', x: 480, y: 600 },
