...
import { WaterBath,RealPT100,RealTC } from './export.js';
/**
...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            ...
            { Class: RealPT100, id: 'pt', x: 420, y: 260 },
            { Class: RealTC, id: 'tc', x: 120, y: 260 },
            ...
            // { Class:NormallyClosedPushButton,id:'btnstop',x:850,y:290},
            // { Class: PressRelay, id: 'prelay', x: 550, y: 380 },
            // { Class: VoltageRelay, id: 'vrelay', x: 1850, y: 850,rotation:-90 },
            // { Class: AirBottle, id: 'acb', x: 150, y: 50 }, 
            // { Class:PressMeter, id: 'pmeter', x: 250, y: 50 },          
            ...
            { Class: Multimeter, id: 'multimeter', x: 600, y: 30, visible: true },
