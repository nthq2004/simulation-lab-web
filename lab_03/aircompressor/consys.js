...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            //输入电桥
            { Class: PressMeter, id: 'pressmeter', x: 350, y: 435,max:5 },
             { Class: StopValve, id: 'stopvalve', x: 350, y: 635,},
            { Class: TeeConnector, id: 'teeconnector', x: 650, y: 635 },  
            { Class: PressRelay, id: 'pressswitch', x: 1200, y: 35,lowEnd:1,diffStart:1,diffEnd:2,model:'压力开关' },                      
            { Class: AirBottle, id: 'cab', x: 800, y: 435 },
            { Class: AirCompressor, id: 'ac', x: 800, y: 30 },
