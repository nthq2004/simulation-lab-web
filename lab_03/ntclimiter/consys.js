...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            ...
            // ── 电源浪涌电流抑制电路 ──
            // 主回路：DC 24V → NTC（自热式浪涌抑制）→ 电容（1000µF）→ 负载（100Ω）→ GND
            { Class: DCPower, id: 'dcpower', x: 250, y: 250, voltage: 24 },
            { Class: Ground, id: 'gnd2', x: 250, y: 490 },
            { Class: NTCThermistor, id: 'ntc', x: 480, y: 80,
              selfHeatingMode: true, Rref: 10, B: 3500, Rseries: 0.001,
              presetKey: 'NTC-10', delta: 12, C_th: 0.5, T_ambient: 25 },
            { Class: Capacitor, id: 'cap', x: 880, y: 390, capacitance: 1000 },
            { Class: Resistor, id: 'load', x: 1030, y: 390, value: 100, rotation: 90 },
            { Class: Ground, id: 'gnd', x: 1030, y: 490 },

            { Class: Oscilloscope_tri, id: 'osc3', x: 780, y: 160, visible: false },
            ...
            // Modbus 组件
            // { Class: IASServer, id: 'ias', x: 100, y: 20, width: 800, height: 500 },
            // { Class: PLC, id: 'plc', x: 960, y: 40 },
            // { Class: ModbusTempTransmitter, id: 'mb_temp', x: 1000, y: 320 },
            // { Class: ModbusPressTransmitter, id: 'mb_press', x: 1000, y: 480 },
            // { Class: ModbusVFD, id: 'mb_vfd', x: 1150, y: 320 },
            // { Class: ModbusLevelTransmitter, id: 'mb_level', x: 1150, y: 480 },
            // { Class: ModbusValvePositioner, id: 'mb_valve', x: 1300, y: 320 },
            // { Class: ModbusBUSCON, id: 'mb_bus1', x: 100, y: 570 },
            // { Class: ModbusBUSCON, id: 'mb_bus2', x: 200, y: 570 },
            // { Class: ModbusBUSCON, id: 'mb_bus3', x: 300, y: 570 },
        ];
