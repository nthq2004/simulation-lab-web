...
export class TimerRelay extends BaseComponent {
    ...
    _drawModeDial() {
        ...
        this.group.add(this._modePointer);
        ...
        this.group.add(this._modeLabel);
    ...
    _drawRangeDial() {
        ...
        this.group.add(this._rangePointer);
        ...
        this.group.add(this._rangeLabel);
        ...
        this.group.add(this._rangeValueText);
    }
    ...
    _drawTimeDial() {
        ...
        this.group.add(this._timePointer);
        ...
        this.group.add(this._timeDisplayLabel);
        ...
        this.group.add(this._delayValueLabel);
    ...
    _drawIndicatorLights() {
        ...
        this.group.add(this._outputLED);
        this.group.add(new Konva.Text({
            x: ledX - 25, y: ledY + 24,
            text: 'OUT',
            fontSize: 7, fill: '#888',
    ...
    _drawContactSymbols() {
        ...
        this.group.add(this._contact1Symbol);
        ...
        this.group.add(this._contact2Symbol);
        ...
        this.group.add(this._contact1Status);
        ...
        this.group.add(this._contact2Status);
    }
    ...
    _startAnimation() {
        const tick = (ts) => {
            if (this._lastTimestamp !== null) {
                const dt = Math.min((ts - this._lastTimestamp) / 1000, 0.1);
