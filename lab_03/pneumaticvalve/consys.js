...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            //输入电桥
            { Class: DCPower, id: 'dcpower', x: 1150, y: 65 },
            { Class: Ground, id: 'gnd', x: 1150, y: 300 },
            { Class: PIDController, id: 'pid', x: 550, y: 180 },
            { Class: AirBottle, id: 'cab', x: 600, y: 750 },
            { Class: PneumaticValve, id: 'valve2', x: 1050, y: 300 },
            { Class: TempTransmitter, id: 'temptr', x: 200, y: 165 },
            { Class: VariResistor, id: 'varires', x: 200, y: 480 },
            ...
            { Class: AmpMeter, id: 'ampmeter', x: 450, y: 100, visible: true },
