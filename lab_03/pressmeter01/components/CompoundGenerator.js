...
export class CompoundGenerator extends BaseComponent {
    ...
    _drawPrimeMover() {
        ...
        this.group.add(body, exhaust, this._exhaustSmoke, fuelIn, rpmLabel, this._throttleIndicator);
    }
    ...
    _drawCoupling() {
        ...
        this.group.add(shaft, coupling1, coupling2);
    }
    ...
    _drawGeneratorStator() {
        ...
        this.group.add(new Konva.Text({ x: cx-R, y: cy-R-22, width: R*2, text: '复励发电机', fontSize: 8, fontStyle: 'bold', fill: '#4fc3f7', align: 'center' }));
    }
    ...
    _drawInstrumentHead() {
        ...
        this.group.add(new Konva.Text({ x: hx+6, y: hy+17, width: hw-12, text: `${this.Vn}V  ${this.Pn.toFixed(1)}kW  ${this.n_rated}rpm`, fontSize: 7.5, fill: '#78909c', align: 'center' }));
    ...
    _drawLCD() {
        ...
        this.group.add(ring, this._lcdBg, this._rpmArc, this._lcdMain, this._lcdUnit, this._lcdkW, this._lcdEta);
    }
    ...
    _drawSpeedControlPanel() {
        ...
        this.group.add(new Konva.Text({ x: px+4, y: py+2, width: pw-8, text: '● 原动机控制（PID调速器）', fontSize: 8, fontStyle: 'bold', fill: '#ffa726', align: 'center' }));
        ...
        this.group.add(new Konva.Rect({ x: barX, y: sliderY, width: barW, height: 8, fill: '#0d2030', cornerRadius: 4 }));
        this._speedBar = new Konva.Rect({ x: barX, y: sliderY, width: 0, height: 8, fill: '#ffa726', cornerRadius: 4 });
        this.group.add(this._speedBar);
        ...
        this.group.add(this._speedValText);
        ...
        this.group.add(startBtn, startLabel, stopBtn, stopLabel);
        ...
        this.group.add(this._throttleText, this._fuelText, this._totalFuelText);
        
        // 复励方式切换
        const modeY = py + ph - 28;
        this.group.add(new Konva.Text({ x: px + 6, y: modeY - 16, text: '励磁方式:', fontSize: 7.5, fill: '#78909c' }));
        ...
        this.group.add(cumBtn, cumLabel, diffBtn, diffLabel, this._modeIndicator);
    ...
    _drawExternalCharacteristic() {
        ...
        this.group.add(new Konva.Text({ x: cx+4, y: cy+2, width: cw-8, text: '外特性 Vt-IL（工作点追踪）', fontSize: 8, fontStyle: 'bold', fill: '#4fc3f7', align: 'center' }));
        ...
        this.group.add(new Konva.Text({ x: ox-10, y: cy+12, text: 'Vt', fontSize: 7.5, fill: '#4fc3f7' }));
        this.group.add(new Konva.Text({ x: cx+cw-12, y: oy+2, text: 'IL', fontSize: 7.5, fill: '#4fc3f7' }));
        ...
        this.group.add(new Konva.Line({ points: cumPts, stroke: '#4fc3f7', strokeWidth: 1.5, dash: [6, 3], opacity: 0.6 }));
        this.group.add(new Konva.Line({ points: diffPts, stroke: '#ef5350', strokeWidth: 1.5, dash: [6, 3], opacity: 0.6 }));
    ...
    _drawWaveform() {
        ...
        this.group.add(new Konva.Text({ x: wx+4, y: wy+2, width: ww-8, text: 'Vt(V)  IL(A)  n(rpm)  P(kW)', fontSize: 8, fontStyle: 'bold', fill: '#4fc3f7', align: 'center' }));
        ...
        this.group.add(bg, titleBg, this._wLineVt, this._wLineIL, this._wLineSpeed, this._wLinePower);
