...
export class GasStove extends BaseComponent {
    ...
    _init() {
        ...
        // 动态层
        this._flameGroupL  = new Konva.Group(); this.group.add(this._flameGroupL);
        this._flameGroupR  = new Konva.Group(); this.group.add(this._flameGroupR);
        this._sparkGroupL  = new Konva.Group(); this.group.add(this._sparkGroupL);
        this._sparkGroupR  = new Konva.Group(); this.group.add(this._sparkGroupR);
        this._tcGroupL     = new Konva.Group(); this.group.add(this._tcGroupL);
        this._tcGroupR     = new Konva.Group(); this.group.add(this._tcGroupR);
        this._knobGroupL   = new Konva.Group(); this.group.add(this._knobGroupL);
        this._knobGroupR   = new Konva.Group(); this.group.add(this._knobGroupR);
        this._schGroup     = new Konva.Group(); this.group.add(this._schGroup);
        this._panelGroup   = new Konva.Group(); this.group.add(this._panelGroup);
