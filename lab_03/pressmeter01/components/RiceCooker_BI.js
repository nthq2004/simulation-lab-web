...
export class BimetallicRiceCooker extends BaseComponent {
    ...
    _init() {
        ...
        this._drawLabel();
        // 动态层
        this._bimetalGroup = new Konva.Group(); this.group.add(this._bimetalGroup);
        this._contactGroup = new Konva.Group(); this.group.add(this._contactGroup);
        this._wireGroup    = new Konva.Group(); this.group.add(this._wireGroup);
    ...
    _drawHeatingPlate() {
        ...
        this.group.add(this._heaterGlow);
    }
