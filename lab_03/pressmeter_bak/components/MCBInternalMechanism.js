...
export class MCBInternalMechanism extends BaseComponent {
    ...
    _drawFixedContact() {
        ...
        this.group.add(this._staticContact);
        ...
        this.group.add(this._contactGlow);
    ...
    _drawOperatingMechanism() {
        ...
        this.group.add(this._handleText);
        ...
        this.group.add(this._upperLatch);
        ...
        this.group.add(this._lowerLatch);
        ...
        this.group.add(this._latchSpring);
    ...
    _drawBimetal() {
        ...
        this.group.add(this._bimetalPath);
        ...
        this.group.add(this._bimetalPath2);
        ...
        this.group.add(this._bimetalHeat);
    ...
    _drawSolenoid() {
        ...
        this.group.add(this._plungerSpring);
        ...
        this.group.add(this._solenoidGlow);
