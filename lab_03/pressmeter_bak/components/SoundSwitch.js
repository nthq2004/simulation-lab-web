...
export class SoundSwitch extends BaseComponent {
    ...
    _drawScrews() {
        ...
        [
            ...
            this.group.add(new Konva.Line({ points:[x-r*0.55,y, x+r*0.55,y], stroke:'#707070', strokeWidth:0.9, lineCap:'round' }));
            this.group.add(new Konva.Line({ points:[x,y-r*0.55, x,y+r*0.55], stroke:'#707070', strokeWidth:0.9, lineCap:'round' }));
        });
    }
    ...
    _drawTerminalArea() {
        ...
        [
            ...
            this.group.add(new Konva.Circle({ x, y: termY, radius: r, fill: '#383838', stroke: '#888', strokeWidth: 0.8 }));
            this.group.add(new Konva.Rect({ x: x-r*0.55, y: termY+r*0.55, width: r*1.1, height: r*0.9, fill: color, cornerRadius: 1 }));
            this.group.add(new Konva.Text({ x: x-6, y: ta.y-11, text: label, fontSize: 7.5, fill: '#505050', fontStyle: 'bold' }));
        });
    }
    ...
    _drawLabel() {
        ...
        this.group.add(this._delayLabel);
    }
