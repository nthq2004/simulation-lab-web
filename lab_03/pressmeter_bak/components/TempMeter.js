...
export class TempMeter extends BaseComponent {
    ...
    _drawPipe() {
        ...
        this.group.add(this._capLumen);

        // ── 毛细管内流体色带（温度色，脉动波传播）──
        this._capFluidGroup = new Konva.Group();
        this.group.add(this._capFluidGroup);
        this._capFluidSegs = [];
        ...
        this.group.add(this._bulbShell);

        // ── 内部液体填充（温度色 + 液位变化）──
        this._liquidGroup = new Konva.Group({ x: bx, y: by });
        this.group.add(this._liquidGroup);
        ...
        this.group.add(this._pressLabel);
