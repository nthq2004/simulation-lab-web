...
import { HandheldTempMeter } from './components/HandheldTempMeter.js';
...
export {
    ...
    AlarmLogger, HistoryRecorder, ReplayController,
    PHASE2_ALL_DEVICES, MAIN_ENGINE_DEVICES, GENERATOR_DEVICES, FUEL_OIL_DEVICES, COMPRESSED_AIR_DEVICES,
    SHIP_WORKFLOWS, FAULT_CONFIGS, ScenarioManager, PRE_BUILT_SCENARIOS,
...
export {
    ...
    VoltageRelay, ACPower, Oscilloscope_tri, Oscilloscope, SignalGenerator, Capacitor, JFET, Diode, Transistor, NpnTempSensor, RealResistor, RealVariResistor, CoolingSystem,
...
export {
    ThreeValve,StrainCylinderSensor,PneumaticValve,AirCompressor,NTCThermistor,PTCThermistor,NTCtempTransmitter,BimetallicThermometer,MercuryThermometer,TempMeter,IRThermometer,HandheldTempMeter,BourdonTube,DiaphragmGauge,HeatExchanger,Governor,GeneratorUnit,Switchboard,FuelTank,OilSeparator,AirDistributor
};
