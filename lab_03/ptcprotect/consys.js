...
AirCompressor,NTCThermistor,PTCThermistor,NTCtempTransmitter,
 } from './export.js';
...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            ...
            // ── PTC 过热保护电路 ──
            // 主回路：DC 12V → PTC（过热保护元件）→ 负载（5Ω 模拟电机/加热器）→ GND
            // PTCThermistor 是自包含的仿真组件，自带 R-T 曲线、LCD 仪表、波形显示
            { Class: DCPower, id: 'dcpower', x: 150, y: 250, voltage: 12 },
            { Class: Ground, id: 'gnd2', x: 150, y: 490 },
            { Class: PTCThermistor, id: 'ptc', x: 480, y: 80,
              presetKey: 'PTC-80',
              Rmin: 10, Rmax: 1e7, Tswitch: 80, Tcurie: 110,
              Vsupply: 12, Rload: 5, Ilimit: 2.0,
              thermalCap: 0.5, thermalRes: 15, deltaConst: 5,
              initTemp: 25 },
            { Class: Resistor, id: 'load', x: 1150, y: 390, value: 5, rotation: 90 },
            { Class: Ground, id: 'gnd', x: 1150, y: 490 },
