...
export class DirectionalValve43 extends BaseComponent {
    ...
    _drawBodyBase() {
        ...
        [b.x + b.w * 0.06, b.x + b.w * 0.94].forEach(bx => {
            ...
            this.group.add(new Konva.Circle({ x: bx, y: boltY, radius: r, fill: '#777', stroke: '#444', strokeWidth: 0.8 }));
            this.group.add(new Konva.Line({ points: [bx-r*0.65,boltY, bx+r*0.65,boltY], stroke:'#444', strokeWidth:1.0, lineCap:'round' }));
            this.group.add(new Konva.Line({ points: [bx,boltY-r*0.65, bx,boltY+r*0.65], stroke:'#444', strokeWidth:1.0, lineCap:'round' }));
        });
        // 阀孔背景（镗孔内腔）
        const bo = this._bore;
        this.group.add(new Konva.Rect({
    ...
    _drawSolenoidCases() {
        [
            ...
            this.group.add(new Konva.Rect({ x: wX, y: wY, width: wW, height: wH, fill: '#120e0a', stroke: '#2a2218', strokeWidth: 0.5, cornerRadius: 2 }));
            for (let i = 0; i < 6; i++) {
    ...
    _drawIsoSymbol() {
        ...
        this.group.add(new Konva.Line({ points: [mcx-bw*0.13,mcy-bh*0.13, mcx+bw*0.13,mcy+bh*0.13], stroke:'#777', strokeWidth:1 }));
        this.group.add(new Konva.Line({ points: [mcx+bw*0.13,mcy-bh*0.13, mcx-bw*0.13,mcy+bh*0.13], stroke:'#777', strokeWidth:1 }));
        ...
        const springSymbol = (ox, oy, dir) => {
            ...
            this.group.add(new Konva.Line({ points: pts, stroke: '#889', strokeWidth: 0.8, lineJoin: 'round' }));
        };
        ...
        const electMagnet = (ox, oy) => {
            this.group.add(new Konva.Rect({ x: ox, y: oy, width: bw*0.30, height: bh*0.55, stroke:'#557', strokeWidth:0.8, fill:'rgba(60,80,140,0.15)', cornerRadius:1 }));
            this.group.add(new Konva.Line({ points:[ox+bw*0.15,oy-bh*0.10, ox+bw*0.15,oy], stroke:'#779', strokeWidth:0.9 }));
        };
        ...
        [
            ...
            this.group.add(new Konva.Text({ x, y: portLabelY, text, ...portLabelStyle }));
        });
    }
    ...
    _drawPortLabels() {
        ...
        pLabels.forEach(({ text, x, y, fill }) => {
            this.group.add(new Konva.Text({ x, y, text, fill, ...lStyle }));
        });
    }
    ...
    _drawStatusIndicator() {
        ...
        this.group.add(this._statusText, this._dotA, this._dotB);
    }
