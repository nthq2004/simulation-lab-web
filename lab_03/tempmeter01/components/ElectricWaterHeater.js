...
export class ElectricWaterHeater extends BaseComponent {
    ...
    _drawLCD() {
        ...
        this.group.add(this._lcdUnitText);
        ...
        this.group.add(this._lcdSetText);
    ...
    _drawKnob() {
        ...
        this.group.add(this._knobGroup);
    ...
    _drawPowerButton() {
        ...
        this.group.add(this._pwrOuter, this._pwrBtn, this._pwrIcon);
