...
export class InductionCooker extends BaseComponent {
    ...
    _drawPot() {
        ...
        this.group.add(this._potBottomEllipse);
    ...
    _drawWater() {
        ...
        this.group.add(this._waterSurface);
        ...
        this.group.add(this._waterTempText);
    }
    ...
    _drawControlPanel() {
        ...
        this.group.add(this._displayRunText, this._displayTempText, this._displayTimeText);
        ...
        this.group.add(this._powerBtn, this._powerIconArc, this._powerIconLine);
        this.group.add(new Konva.Text({
        ...
        this.group.add(this._minusBtn, this._minusBtnText);
        ...
        this.group.add(this._levelText);
        ...
        this.group.add(this._plusBtn, this._plusBtnText);
        this.group.add(new Konva.Text({
            x: W * 0.65, y: ctrlY + 12,
        ...
        this.group.add(this._statusLed);
        this.group.add(new Konva.Text({
    ...
    _buildDynamicLayers() {
        ...
        this.group.add(this._eddyGroup);
