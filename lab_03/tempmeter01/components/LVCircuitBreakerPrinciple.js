...
export class LVCircuitBreakerPrinciple extends BaseComponent {
    ...
    _drawReleaseSpring() {
        ...
        this.group.add(this._releaseSpring);
        // 弹簧上端固定点
    ...
    _drawThermalTripper() {
        ...
        this.group.add(this._thermalPathHot);
        ...
        this.group.add(this._thermalGlow);
        ...
        this.group.add(this._thermalText);
    ...
    _drawOvercurrentTripper() {
        ...
        this.group.add(this._ocPlungerShape);
        ...
        this.group.add(this._ocPushrod);
    ...
    _drawUndervoltageTripper() {
        ...
        this.group.add(this._uvPlungerShape);
        ...
        this.group.add(this._uvPushrod);
    ...
    _drawShuntTripper() {
        ...
        this.group.add(this._shuntPlungerShape);
        ...
        this.group.add(this._shuntPushrod);
        ...
        this.group.add(this._shuntGlow);
    ...
    _buildLatchGroup() {
        ...
        this.group.add(this._latchGroup);
    }
    ...
    _buildTripLeverGroup() {
        ...
        this.group.add(this._tripLeverGroup);
    }
    ...
    _buildLinkageGroup() {
        ...
        this.group.add(this._linkageGroup);
    }
    ...
    _buildCurrentGroup() {
        ...
        this.group.add(this._currentGroup);
    }
    ...
    _drawLabels() {
        ...
        this.group.add(this._stateDisplay);
    }
