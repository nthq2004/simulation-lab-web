...
export class PneumaticValve32 extends BaseComponent {
    ...
    _drawIsoSymbol() {
        ...
        this.group.add(new Konva.Line({ points: spts, stroke: '#889', strokeWidth: 0.7, lineJoin: 'round' }));
        ...
        [
            ...
            this.group.add(new Konva.Text({ x, y, text: t, fontSize: 7, fontStyle:'bold', fill:'#7a8a9a' }));
        });

        // "常态" / "动作" 标注
        this.group.add(new Konva.Text({ x: sx + bw*0.20, y: sy + bh + 10, text:'常态', fontSize:6, fill:'#556677' }));
        this.group.add(new Konva.Text({ x: sx + bw*1.20, y: sy + bh + 10, text:'动作', fontSize:6, fill:'#556677' }));
    }
    ...
    _drawPortLabels() {
        ...
        portLabels.forEach(({ t, x, y, fill }) => {
            this.group.add(new Konva.Text({ x, y, text: t, fontSize: 8, fontStyle: 'bold', fill }));
        });
    }
    ...
    _drawStatusIndicator() {
        ...
        this.group.add(this._statusDot, this._statusText, this._pilotDot);
    }
