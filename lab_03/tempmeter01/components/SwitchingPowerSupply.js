...
export class SwitchingPowerSupply extends BaseComponent {
    ...
    _drawBridge(cx, cy, r) {
        ...
        // 顶底节点（AC输入）
        this.group.add(new Konva.Circle({ x:pts.top.x, y:pts.top.y, radius:3, fill:'#c84040' }));
        this.group.add(new Konva.Circle({ x:pts.bot.x, y:pts.bot.y, radius:3, fill:'#6080c0' }));
        // 左右节点（DC±）
        this.group.add(new Konva.Circle({ x:pts.right.x, y:pts.right.y, radius:3.5, fill:'#e08040' }));
        this.group.add(new Konva.Circle({ x:pts.left.x,  y:pts.left.y,  radius:3.5, fill:'#4060a0' }));
        // 标注
        this.group.add(new Konva.Text({
    ...
    _drawElectrolyticCap(cx, cy, topY, botY) {
        ...
        // 引线
        this.group.add(new Konva.Line({ points:[cx,topY-2,cx,topY-6], stroke:'#e08040', strokeWidth:1.2 }));
        this.group.add(new Konva.Line({ points:[cx,botY+2,cx,botY+6], stroke:'#4060a0', strokeWidth:1.2 }));
    }
    ...
    _drawMOSFET(cx, cy) {
        ...
        // 栅极(G) 引线
        this.group.add(new Konva.Line({ points:[cx-16,cy, cx-24,cy], stroke:'#90c0ff', strokeWidth:1.5 }));
        // 栅极绝缘层
        this.group.add(new Konva.Line({ points:[cx-10,cy-14, cx-10,cy+14], stroke:'#5090d0', strokeWidth:2.5 }));
        // 沟道线
        this.group.add(new Konva.Line({ points:[cx-6,cy-14, cx-6,cy-4],  stroke:'#80b0e0', strokeWidth:1.5 }));
        this.group.add(new Konva.Line({ points:[cx-6,cy+4,  cx-6,cy+14], stroke:'#80b0e0', strokeWidth:1.5 }));
        // D/S引线
        this.group.add(new Konva.Line({ points:[cx-6,cy-14, cx+16,cy-14, cx+16,cy-24], stroke:'#80b0e0', strokeWidth:1.5 }));
        this.group.add(new Konva.Line({ points:[cx-6,cy+14, cx+16,cy+14, cx+16,cy+24], stroke:'#80b0e0', strokeWidth:1.5 }));
        // 体二极管
        this.group.add(new Konva.Line({ points:[cx+8,cy-10, cx+8,cy+10], stroke:'#f08040', strokeWidth:1 }));
        this.group.add(new Konva.Line({ points:[cx+5,cy-6,  cx+11,cy-6, cx+8,cy+8], stroke:'#f08040', strokeWidth:1, closed:true, fill:'rgba(240,120,50,0.3)' }));
        // 标注
        this.group.add(new Konva.Text({ x:cx-8, y:cy-24, text:'D', fontSize:7, fill:'#a0c0e0', fontFamily:'monospace' }));
        this.group.add(new Konva.Text({ x:cx-8, y:cy+16, text:'S', fontSize:7, fill:'#a0c0e0', fontFamily:'monospace' }));
        this.group.add(new Konva.Text({ x:cx-24, y:cy-4,  text:'G', fontSize:7, fill:'#a0c0e0', fontFamily:'monospace' }));
        this.group.add(new Konva.Text({
    ...
    _drawSnubber(cx, cy) {
        // RCD缓冲：R+C+D 串联
        this.group.add(new Konva.Rect({ x:cx-5, y:cy-8, width:10, height:16, fill:'#2a1810', stroke:'#804020', strokeWidth:1, cornerRadius:2 }));
        this.group.add(new Konva.Text({ x:cx-5, y:cy+10, text:'RCD', fontSize:5.5, fill:'#7a5030', fontFamily:'monospace' }));
        this.group.add(new Konva.Text({ x:cx-5, y:cy-18, text:'Snubber', fontSize:5.5, fill:'#5a4020', fontFamily:'monospace' }));
    }
    ...
    _drawInductor(cx, cy, label) {
        ...
        // 引线
        this.group.add(new Konva.Line({ points:[cx-totalW/2-8,cy, cx-totalW/2,cy], stroke:'#40d090', strokeWidth:1.5 }));
        this.group.add(new Konva.Line({ points:[cx+totalW/2,cy, cx+totalW/2+8,cy], stroke:'#40e090', strokeWidth:1.5 }));
        // 螺旋弧
        for (let i=0; i<turns; i++) {
            ...
            this.group.add(new Konva.Line({ points:pts, stroke:'#60c090', strokeWidth:2, lineCap:'round', lineJoin:'round' }));
        }
        this.group.add(new Konva.Text({ x:cx-12, y:cy-18, text:label, fontSize:7, fill:'#50b080', fontFamily:'monospace' }));
    }
    ...
    _drawOutputCap(cx, cy) {
        ...
        this.group.add(new Konva.Text({ x:cx-7, y:cy+capH/2+2, text:'Cout', fontSize:6, fill:'#50a050', fontFamily:'monospace' }));
        this.group.add(new Konva.Line({ points:[cx,cy-capH/2, cx,cy-capH/2-5], stroke:'#40e090', strokeWidth:1.2 }));
        this.group.add(new Konva.Line({ points:[cx,cy+capH/2, cx,cy+capH/2+5], stroke:'#408060', strokeWidth:1.2 }));
    }
    ...
    _drawStage5_DCOutput() {
        ...
        this.group.add(this._voutDisplay);
        this.group.add(new Konva.Text({
    ...
    _drawMiniResistor(cx, cy, label) {
        this.group.add(new Konva.Rect({ x:cx-8,y:cy-5, width:16,height:10, fill:'#2a1810', stroke:'#806030', strokeWidth:1, cornerRadius:2 }));
        this.group.add(new Konva.Text({ x:cx+10,y:cy-5, text:label, fontSize:6, fill:'#806040', fontFamily:'monospace' }));
    }
    ...
    _drawTL431(cx, cy) {
        ...
        // 内部基准符号
        this.group.add(new Konva.Line({ points:[cx-5,cy-5, cx+5,cy+5], stroke:'#60a0f0', strokeWidth:1.2 }));
        this.group.add(new Konva.Line({ points:[cx-5,cy+5, cx+5,cy-5], stroke:'#60a0f0', strokeWidth:1.2 }));
        this.group.add(new Konva.Text({
    ...
    _drawOptocoupler(cx, cy) {
        ...
        // LED侧（左）
        this.group.add(new Konva.Line({ points:[cx-8,cy-8, cx-8,cy+8, cx-2,cy, cx-8,cy-8], stroke:'#f06040', strokeWidth:1.2, closed:true, fill:'rgba(240,80,40,0.2)' }));
        this.group.add(new Konva.Line({ points:[cx-2,cy-8, cx-2,cy+8], stroke:'#f06040', strokeWidth:1.5 }));
        // 光线箭头
        this.group.add(new Konva.Line({ points:[cx-1,cy-4, cx+3,cy-8], stroke:'#ffcc40', strokeWidth:1, dash:[2,1] }));
        this.group.add(new Konva.Line({ points:[cx-1,cy+4, cx+3,cy-0], stroke:'#ffcc40', strokeWidth:1, dash:[2,1] }));
        // 光敏三极管侧（右）
        this.group.add(new Konva.Circle({ x:cx+7, y:cy, radius:5, fill:'#101818', stroke:'#40a080', strokeWidth:1 }));
        this.group.add(new Konva.Text({
    ...
    _drawStatusBar() {
        ...
        this.group.add(this._statusDot);
    }
