...
export class MagnetoTorqueSensor extends BaseComponent {
    ...
    _drawShaftAssembly() {
        ...
        this.group.add(this._torsionBar);
        ...
        this.group.add(this._twistLine);
    ...
    _drawWaveArea() {
        ...
        this.group.add(this._phaseHighlight);
        ...
        this.group.add(this._wave1Line);
        this.group.add(this._wave2Line);
        ...
        this.group.add(this._phaseDiffText);
    }
    ...
    _drawMeasureCircuit() {
        ...
        this.group.add(new Konva.Text({ x: mx + 2, y: xorCY - 10, text: '1', fontSize: 7, fill: '#4090ff', fontFamily: 'Arial' }));
        this.group.add(new Konva.Text({ x: mx + 2, y: xorCY + 2,  text: '2', fontSize: 7, fill: '#40ff90', fontFamily: 'Arial' }));
    ...
    _drawNeedle(x, y, w, h) {
        ...
        this.group.add(this._needleShape);
    ...
    _drawTorqueSlider() {
        ...
        this.group.add(this._torqueKnob);
        ...
        this.group.add(this._torqueValueText);
        ...
        this.group.add(this._rpmValueText);
    }
