...
export class MrIICoolingControllerRevB extends BaseComponent {
    ...
    _drawShell() {
        ...
        [[s.x+12,s.y+10],[s.x+s.w-12,s.y+10],
         [s.x+12,s.y+s.h-10],[s.x+s.w-12,s.y+s.h-10]].forEach(([x,y])=>{
            this.group.add(new Konva.Circle({x,y,radius:sR,fill:'#7888a0',stroke:'#404858',strokeWidth:0.6}));
            this.group.add(new Konva.Line({points:[x-sR*0.65,y,x+sR*0.65,y],stroke:'#1e2838',strokeWidth:0.8,lineCap:'round'}));
            this.group.add(new Konva.Line({points:[x,y-sR*0.65,x,y+sR*0.65],stroke:'#1e2838',strokeWidth:0.8,lineCap:'round'}));
        });
        this.group.add(new Konva.Rect({
    ...
    _drawTerminalBlock() {
        ...
        [
            ...
            this.group.add(new Konva.Circle({x:px, y:py+3.5, radius:2.2, fill:'#14181e'}));
            this.group.add(new Konva.Text({
    ...
    _drawPWMZoneDynamic() {
        ...
        this._dynGroup.add(new Konva.Text({
            ...
            fill:this._pwmDuty>0.05?dirColor:'#6070808', align:'center', fontStyle:'bold',
        }));
        this._dynGroup.add(new Konva.Text({
