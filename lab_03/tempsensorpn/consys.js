...
import { LeakDetector, AirBottle, PressRegulator, PressMeter, TeeConnector, StopValve, Pump, Cooler, Engine, WaterTankSystem, WaterTankTwoPos, WaterTankLevelControl, DiffTransmitter, BubbleLevelTransmitter, PIDController, OvenSystem, ElecValve, LVDTPressureSensor, TempTransmitter, PressTransmitter, SmartPressTransmitter, Rosemount475, VoltageTransmitter, DCPower, AmpMeter, VariResistor, Resistor, Multimeter, OpAmp, Ground, Monitor, ProcessCalibrator, VoltageRelay, ACPower, Oscilloscope_tri, Oscilloscope, SignalGenerator, Capacitor, JFET, Diode, Transistor, NpnTempSensor, RealResistor, RealVariResistor, CoolingSystem, FuelOilHeater, PressRelay, AudioVisualAlarm, NormallyClosedPushButton, NormallyOpenPushButton } from './export.js';
...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            ...
            { Class: Multimeter, id: 'multimeter', x: 1350, y: 500, visible: true },
            { Class: AmpMeter, id: 'ampmeter', x: 450, y: 100, visible: false },
            { Class: ProcessCalibrator, id: 'cali', x: 600, y: 100, visible: false },

            // ── Brokaw 温度传感器 ──
            { Class: DCPower, id: 'b_vcc', x: 350, y: 0, voltage: 15 },
            { Class: NpnTempSensor, id: 'b_q1', x: 400, y: 400, areaRatio: 1 },
            { Class: NpnTempSensor, id: 'b_q2', x: 550, y: 400, areaRatio: 8 },
            { Class: Resistor, id: 'b_r1', x: 580, y: 520, value: 180, direction: 'vertical' },
            { Class: Resistor, id: 'b_r2', x: 350, y: 240, value: 10000, direction: 'vertical' },
            { Class: Resistor, id: 'b_r3', x: 600, y: 240, value: 10000, direction: 'vertical' },
            { Class: OpAmp, id: 'b_u1', x: 850, y: 320, source: 15, inputOffset: 0.001 },

            { Class: Resistor, id: 'b_r4', x: 640, y: 520, value: 305748, direction: 'vertical' },
            { Class: Resistor, id: 'b_r5', x: 640, y: 620, value: 1000, direction: 'vertical' },
            { Class: OpAmp, id: 'b_u2', x: 800, y: 500, source: 15, inputOffset: 0.0008 },

            { Class: Resistor, id: 'b_r6', x: 940, y: 450, value: 1000 },
            { Class: Resistor, id: 'b_r7', x: 1100, y: 390, value: 55555 },
            { Class: Resistor, id: 'b_r8', x: 940, y: 520, value: 1000 },
            { Class: Resistor, id: 'b_r9', x: 980, y: 620, value: 55555, direction: 'vertical' },
            { Class: OpAmp, id: 'b_u3', x: 1100, y: 500, source: 15, inputOffset: 0.0008 },
            { Class: Ground, id: 'b_gnd1', x: 400, y: 600 },
            { Class: Ground, id: 'b_gnd2', x: 600, y: 800 },
            { Class: Ground, id: 'b_gnd3', x: 1240, y: 600 },
            { Class: Ground, id: 'b_gnd4', x: 200, y: 200 },
        ...
        // ── Modbus 网络系统 ──
        // const mbTemp = this.comps['mb_temp'];
        // const mbPress = this.comps['mb_press'];
        // const mbVfd = this.comps['mb_vfd'];
        // const mbLevel = this.comps['mb_level'];
        // const mbValve = this.comps['mb_valve'];
        // const mbPlc = this.comps['plc'];
        // const mbIas = this.comps['ias'];

        // if (mbPlc && mbIas) {
        //     this.modbusBus = createModbusSystem({
        //         plc: mbPlc,
        //         ias: mbIas,
        //         temp: mbTemp,
        //         press: mbPress,
        ...
        //         valve: mbValve,
        //     });
        //     console.log('[consys] Modbus 系统初始化完成');
        // } else {
        //     console.warn('[consys] Modbus 组件缺失，跳过初始化');
        // }
    ...
    _updatePhysics() {
        ...
        if (this.modbusBus) {
            try {
                this.modbusBus.update();
            } catch (e) {
                console.warn('[consys] Modbus update error:', e);
            }
        }
    }
    ...
    _initTempSlider() {
        ...
        sliderDiv.innerHTML = `
            ...
            <input type="range" id="tempSlider" min="-40" max="150" value="0" style="width:120px;">
            <span id="tempDisplay" style="font-size:12px;min-width:50px;">0°C</span>
        `;
