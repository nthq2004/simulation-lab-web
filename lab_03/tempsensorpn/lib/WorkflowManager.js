...
export class WorkflowManager {
        ...
        sys.stepsArray[1] = [
            ...
            // --- 第3步：T=0°C观察 ---
            {
                ...
                act: async () => {
                    ...
                    sys.showFloatingTip(`T=0°C: ΔVbe=${(vR1||0).toFixed(4)}V  Vout=V_R2=${(vDropR2||0).toFixed(4)}V (10mV/°C)`, 4000);
                },
                check: () => true
            },
            ...
            // --- 第4步：T=25°C观察 ---
            {
                ...
                act: async () => {
                    ...
                    const vR1 = sys.getVoltageBetween('b_r1_wire_l', 'b_r1_wire_r');
                    const vDropR2 = sys.getVoltageBetween('b_vcc_wire_p', 'b_q1_wire_c');
                    sys.showFloatingTip(`T=25°C: ΔVbe=${(vR1||0).toFixed(4)}V  Vout=V_R2=${(vDropR2||0).toFixed(4)}V (10mV/°C)`, 4000);
                },
                check: () => true
            },
            ...
            // --- 第5步：T=50°C观察 ---
            {
                ...
                act: async () => {
                    ...
                    const vR1 = sys.getVoltageBetween('b_r1_wire_l', 'b_r1_wire_r');
                    const vDropR2 = sys.getVoltageBetween('b_vcc_wire_p', 'b_q1_wire_c');
                    sys.showFloatingTip(`T=50°C: ΔVbe=${(vR1||0).toFixed(4)}V  Vout=V_R2=${(vDropR2||0).toFixed(4)}V (10mV/°C)`, 4000);
                },
                check: () => true
            },
            ...
            // --- 第6步：T=100°C观察 ---
            {
                ...
                act: async () => {
                    ...
                    const vR1 = sys.getVoltageBetween('b_r1_wire_l', 'b_r1_wire_r');
                    const vDropR2 = sys.getVoltageBetween('b_vcc_wire_p', 'b_q1_wire_c');
                    sys.showFloatingTip(`T=100°C: ΔVbe=${(vR1||0).toFixed(4)}V  Vout=V_R2=${(vDropR2||0).toFixed(4)}V (10mV/°C)`, 4000);
                },
                check: () => true
            },
            ...
            // --- 第7步：实验总结 ---
            {
                ...
                act: async () => {
                    ...
                    sys.showFloatingTip(
                        ...
                        "R1=180Ω, ΔVbe 流过 R1 生成 PTAT 电流\n" +
                        "Vout = V_R2 = (R2/R1)×ΔVbe = 55.6×ΔVbe\n" +
                        "温度系数 = 55.6×0.18mV/°C ≈ 10mV/°C\n" +
                        "0°C~100°C: Vout 从 2.72V 增至 3.72V (变化 1.0V)",
                        6000
                    );
                },
                check: () => true
    ...
    applyAllPresets() {
        ...
        sys.conns = [
            ...
            { from: 'b_vcc_wire_p', to: 'b_r4_wire_l', type: 'wire' },            
            { from: 'b_r4_wire_r', to: 'b_r5_wire_l', type: 'wire' },
            { from: 'b_r5_wire_r', to: 'b_gnd2_wire_gnd', type: 'wire' },
        ];
        sys.redrawAll();
    }
    ...
    fiveStep() {
        ...
        const vR1 = sys.getVoltageBetween('b_r1_wire_l', 'b_r1_wire_r');
        const vOut = sys.getVoltageBetween('b_u3_wire_OUT', 'b_gnd4_wire_gnd');
        if (sys.showFloatingTip) {
            sys.showFloatingTip(
                `T=${nextTemp}°C  ΔVbe=${(vR1 || 0).toFixed(4)}V  Vout=${(vOut || 0).toFixed(4)}V`,
                3000
            );
        }
    }
