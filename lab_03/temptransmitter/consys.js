...
import { WaterBath, RealPT100, RealTC,ThreeValve } from './export.js';
/**
...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            //加热水箱和PT100
            { Class: WaterBath, id: 'temptest', x: -100, y: 800 },
            { Class: RealPT100, id: 'pt100', x: 120, y: 820 },
            //电源、地、电桥
            { Class: DCPower, id: 'dcpower', x: 50, y: 10, voltage: 5 },
            { Class: Ground, id: 'gndx', x: 50, y: 240 },
            { Class: Resistor, id: 'r1', x: 100, y: 300, direction: 'vertical' },
            { Class: Resistor, id: 'r2', x: 250, y: 300, direction: 'vertical' },
            { Class: VariResistor, id: 'pt', value: 385.1, cvalue: 100, x: 80, y: 450, direction: 'vertical' },
            { Class: VariResistor, id: 'varires', value: 200, x: 250, y: 450, direction: 'vertical' },
            { Class: Ground, id: 'gnd0', x: 150, y: 665 },
            //前置放大、4个电阻、两个运放
            { Class: Resistor, id: 'r5k', x: 420, y: 480, value: 5000, direction: 'vertical' },
            { Class: VariResistor, id: 'r10kv', x: 430, y: 250, value: 10000, cvalue: 5000, direction: 'vertical' },
            ...
            { Class: DCPower, id: 'dcpower2', x: 1000, y: 30 },            
            { Class: Ground, id: 'gnd2', x: 1500, y: 665 },
            { Class: PIDController, id: 'pid', x: 1300, y: 0 },
