...
export class SmartAnalogSwitch extends BaseComponent {
    constructor(config, sys) {
        ...
        this.functions = ['DCA', 'DCV', 'ACV', 'R', 'C', 'Diode'];
    ...
    _drawStatic() {
        ...
        this._staticGroup.add(new Konva.Text({
            x: W - 16, y: 54, text: 'A', fontSize: 10, fill: '#1f8b4c', listening: false,
        }));
        this._staticGroup.add(new Konva.Text({
            x: W - 16, y: 114, text: 'B', fontSize: 10, fill: '#1f8b4c', listening: false,
        }));
    }
