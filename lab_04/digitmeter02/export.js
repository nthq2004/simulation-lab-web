...
import { PROJECT_WORKFLOWS,FAULT_CONFIGS,componentConfigs } from './project/digitmeter_DCV.js';
...
export {
    ...
    VoltageTransmitter, DCPower, DCCurrent, DCVoltage, AmpMeter, VariResistor, Resistor, Multimeter, OpAmp, Ground, 
...
export {
    ...
    GlassPlateLevelGauge,SealedOilTank,SmartAnalogSwitch,DMMController
};
