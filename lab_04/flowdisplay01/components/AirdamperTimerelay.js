...
export class AirDamperTimeRelay extends BaseComponent {
    ...
    _init() {
        ...
        this._staticGroup.add(this._bellowsDynGroup);
        this._staticGroup.add(this._magnetDynGroup);
        this._staticGroup.add(this._contactDynGroup);
        this._staticGroup.add(this._progressDynGroup);
        this._staticGroup.add(this._knobDynGroup);
    ...
    _drawBody() {
        ...
        [[b.x + 7, b.y + 7], [b.x + b.w - 7, b.y + 7],
         [b.x + 7, b.y + b.h - 7], [b.x + b.w - 7, b.y + b.h - 7]
            ...
            this._staticGroup.add(new Konva.Circle({ x: sx, y: sy, radius: 3.2, fill: '#484850', stroke: '#28283a', strokeWidth: 0.6 }));
            this._staticGroup.add(new Konva.Line({ points: [sx - 2, sy - 2, sx + 2, sy + 2], stroke: '#383848', strokeWidth: 0.8 }));
        });

        // 型号铭牌
        const npY = b.y + b.h * 0.92;
        this._staticGroup.add(new Konva.Rect({ x: b.x + b.w * 0.10, y: npY, width: b.w * 0.80, height: H * 0.04, fill: '#181820', stroke: '#0e0e18', strokeWidth: 0.5, cornerRadius: 1 }));
    ...
    _drawTerminals() {
        ...
        this._staticGroup.add(new Konva.Text({ x: this._ports[0].x - 6, y: ty0, text: '线圈', fontSize: 6.5, fill: 'rgba(230,180,80,0.42)', fontFamily: 'Courier New' }));
        this._staticGroup.add(new Konva.Text({ x: this._ports[2].x - 6, y: ty0, text: '延时NO(3-4)', fontSize: 6, fill: 'rgba(100,160,210,0.42)', fontFamily: 'Courier New' }));
        this._staticGroup.add(new Konva.Text({ x: this._ports[4].x - 6, y: ty0, text: 'NC(5-6)', fontSize: 6, fill: 'rgba(100,190,120,0.42)', fontFamily: 'Courier New' }));
    }
    ...
    _bindInteraction() {
        ...
        this._interactGroup.add(coilHit);
