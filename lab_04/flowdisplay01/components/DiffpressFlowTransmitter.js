...
export class DiffPressFlowTransmitter extends BaseComponent {
    ...
    _drawSensor() {
        ...
        this._viewY = viewY;
        this._staticGroup.add(outerRing, gripRing, this._lcdBg);
    }
    ...
    _drawLCD() {
        ...
        this._staticGroup.add(this._lcdMain, this._lcdUnit, this._lcdDp, this._lcdmA);
    }
    ...
    _drawPipeTaps() {
        ...
        this._staticGroup.add(hTap, lTap);
    }
