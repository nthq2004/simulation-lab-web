...
export class EngardCoolingController extends BaseComponent {
    ...
    _drawThreeWayValve(cx, cy, size) {
        ...
        this._staticGroup.add(this._valveArrow);
    ...
    _drawBigKnob() {
        ...
        this._staticGroup.add(this._bigKnobShape);
        ...
        this._staticGroup.add(this._bigKnobPtr);
    ...
    _drawBypassValve(cx, cy, w, h) {
        ...
        this._staticGroup.add(this._bypassArrow);
    }
    ...
    _drawBigDisplay() {
        ...
        this._staticGroup.add(this._bigDispText);
