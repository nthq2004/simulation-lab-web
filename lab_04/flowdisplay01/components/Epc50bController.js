...
export class EPC50BController extends BaseComponent {
    ...
    _drawThreeWayValve(cx, cy) {
        ...
        this._staticGroup.add(this._threeWayIndicator);
        ...
        this._staticGroup.add(this._threeWayPosText);
    ...
    _drawLevelSwitch(cx, cy) {
        ...
        this._staticGroup.add(this._lsLiquid);
        this._staticGroup.add(new Konva.Text({
    ...
    _drawSRV(cx, cy) {
        ...
        this._staticGroup.add(this._srvFill);
        
        this._srvPosText = new Konva.Text({
            x: cx - 14, y: cy + 22, width: 28, text: '0%',
            fontSize: 6.5, fill: '#1a3a5a', fontFamily: 'Arial', align: 'center',
        });
        this._staticGroup.add(this._srvPosText);
    ...
    _drawCtrlArea() {
        ...
        this._staticGroup.add(this._ctrlDisp);
        ...
        this._staticGroup.add(this._ctrlParamName);
