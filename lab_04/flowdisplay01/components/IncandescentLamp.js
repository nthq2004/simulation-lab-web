...
export class IncandescentLamp extends BaseComponent {
    ...
    _drawHaloLayer() {
        ...
        this._staticGroup.add(this._haloGroup);
    }
    ...
    _drawBulb() {
        ...
        this._staticGroup.add(this._bulbPath, this._bulbGlow, this._neckRect, this._bulbHL1, this._bulbHL2);
        this._neckY  = neckY;
        this._neckW  = neckW;
    }
    ...
    _drawFilamentLayer() {
        ...
        this._staticGroup.add(this._filamentGroup);
    ...
    _drawInfoPanel() {
        ...
        this._staticGroup.add(this._infoPower, this._infoLife);
    }
