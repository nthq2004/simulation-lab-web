...
export class LCD12864 extends BaseComponent {
    ...
    _drawBacklightLayer() {
        ...
        this._staticGroup.add(this._blGroup);
    ...
    _drawDisplayArea() {
        ...
        this._staticGroup.add(this._dispBg);
    ...
    _drawPixelLayer() {
        ...
        this._staticGroup.add(this._pixGroup);
        this._rebuildPixels();
    }
    ...
    _drawInitOverlay() {
        ...
        this._staticGroup.add(this._initOverlayGroup);
    }
    ...
    _drawCursorLayer() {
        ...
        this._staticGroup.add(this._cursorGroup);
    }
    ...
    _drawLabel() {
        ...
        this._staticGroup.add(this._blStatusText);
    }
