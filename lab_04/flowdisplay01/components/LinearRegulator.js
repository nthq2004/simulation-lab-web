...
export class LinearRegulator extends BaseComponent {
    ...
    _drawStaticWiring() {
        ...
        wires.forEach(pts => {
            this._staticGroup.add(new Konva.Line({ points: pts, ...lineStyle }));
        });
    ...
    _drawPassElement() {
        ...
        this._staticGroup.add(this._passBody);
        ...
        // 引脚标注 C/B/E
        this._staticGroup.add(new Konva.Text({ x: cx-rx*1.5, y: cy-ry*1.1, text:'C', fontSize:8, fill:'#aed0f0', fontStyle:'bold' }));
        this._staticGroup.add(new Konva.Text({ x: cx-rx*1.5, y: cy+ry*0.8, text:'E', fontSize:8, fill:'#aed0f0', fontStyle:'bold' }));
        this._staticGroup.add(new Konva.Text({ x: cx-rx*0.6,  y: cy+ry*1.05,text:'B', fontSize:8, fill:'#aed0f0', fontStyle:'bold' }));
        ...
        this._staticGroup.add(this._passHeatGlow);
    }
