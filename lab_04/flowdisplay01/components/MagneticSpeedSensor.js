...
export class MagneticSpeedSensor extends BaseComponent {
    ...
    _drawSensorProbes() {
        ...
        const drawProbe = (angle, label, color, isChA) => {
            ...
            this._staticGroup.add(probeGroup);
        };
    ...
    _drawJunctionBox() {
        ...
        this._staticGroup.add(body, sheen, plate, this._idText, typeText);
    }
    ...
    _drawWaveformScreen() {
        ...
        this._staticGroup.add(scrBg, this._waveLineA, this._waveLineB,
    ...
    _drawSpeedKnob() {
        ...
        this._interactGroup.add(base, this._knobRotor, knobLbl);
    }
    ...
    _drawDirectionSwitch() {
        ...
        this._interactGroup.add(bg, this._dirBtnFwd, this._dirBtnRev, fwdLbl, revLbl, hit);
    }
