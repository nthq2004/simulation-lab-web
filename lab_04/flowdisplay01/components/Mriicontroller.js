...
export class MRIIController extends BaseComponent {
    ...
    _drawMeterA() {
        ...
        this._staticGroup.add(this._needleShadow);
        ...
        this._staticGroup.add(this._needle);
    ...
    _drawBoardB() {
        ...
        this._staticGroup.add(this._spLabel);
    }
    ...
    _drawToggleSwitch2(cx, cy, numLabel, initState) {
        ...
        this._staticGroup.add(leftH); this._staticGroup.add(rightH);
    ...
    _addParamText(bd, xFrac, initText, align, dynamic) {
        ...
        if (dynamic) this._staticGroup.add(t);
        return t;
    }
