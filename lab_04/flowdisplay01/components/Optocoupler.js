...
export class Optocoupler extends BaseComponent {
    ...
    _drawPinNumbers() {
        ...
        // 引脚功能标注（A / K / C / E）
        const fnFz = 8;
        this._staticGroup.add(new Konva.Text({ x: pkgX - this._pinLen - 14, y: pin1Y - 5,
            text: 'A', fontSize: fnFz, fontStyle: 'bold', fill: '#ef9a9a' }));
        this._staticGroup.add(new Konva.Text({ x: pkgX - this._pinLen - 12, y: pin2Y - 5,
            text: 'K', fontSize: fnFz, fontStyle: 'bold', fill: '#ef9a9a' }));
        this._staticGroup.add(new Konva.Text({ x: pkgX + pkgW + this._pinLen + 4, y: pin1Y - 5,
            text: 'C', fontSize: fnFz, fontStyle: 'bold', fill: '#90caf9' }));
        this._staticGroup.add(new Konva.Text({ x: pkgX + pkgW + this._pinLen + 4, y: pin2Y - 5,
