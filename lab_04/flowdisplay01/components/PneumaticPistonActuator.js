...
export class PneumaticPistonActuator extends BaseComponent {
    ...
    _init() {
        ...
        this._staticGroup.add(this._dynGas, this._dynSpring, this._dynPiston, this._dynPID);
    ...
    _drawCylinderBody() {
        ...
        [
            ...
            this._staticGroup.add(new Konva.Rect({ x:r.x, y:r.y, width:r.w, height:r.h, fill:'#4a5868', opacity:0.85 }));
        ...
        this._staticGroup.add(new Konva.Text({ x: b.x + b.w*0.60 - 8, y: b.y - 17, text: 'A口', fontSize: 7, fill: '#4a6070' }));
        ...
        if (this.doubleActing) {
            ...
            this._staticGroup.add(new Konva.Text({ x: b.x - 18, y: b.y + b.h*0.80 - 2, text: 'B口', fontSize: 7, fill: '#4a6070' }));
        }
    ...
    _drawPositionerBox() {
        ...
        this._staticGroup.add(this._btnAuto, this._btnAutoText, this._btnMan, this._btnManText);
    ...
    _drawHandwheel() {
        ...
        this._staticGroup.add(this._hwBtnUp, this._hwBtnDn);
        ...
        this._staticGroup.add(new Konva.Text({ x: cx - r*0.3, y: cy - r - 14, text: '▲', fontSize: 8, fill: '#80a0c0', listening: true }).on('click tap', () => { if (this._mode==='MANUAL') this._setPositionDirect(Math.min(100, this._position+5)); }));
        this._staticGroup.add(new Konva.Text({ x: cx - r*0.3, y: cy + r + 6, text: '▼', fontSize: 8, fill: '#80a0c0', listening: true }).on('click tap', () => { if (this._mode==='MANUAL') this._setPositionDirect(Math.max(0, this._position-5)); }));
    }
    ...
    _drawLabel() {
        ...
        [
            ...
            this._staticGroup.add(new Konva.Text({ x, y, text, fontSize: 7.5, fill: '#4a6070' }));
        });
    }
    ...
    _drawStatusPanel() {
        ...
        this._staticGroup.add(this._statusRect, this._statusText);
    }
