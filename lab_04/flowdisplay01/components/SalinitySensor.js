...
export class SalinitySensor extends BaseComponent {
    ...
    _drawPipeSection() {
        ...
        this._staticGroup.add(outer, this._flowChannel, this._fluidOverlay, 
    ...
    _drawFlowAnimation() {
        ...
        this._staticGroup.add(this._particleGroup);
    }
    ...
    _drawProbeAssembly() {
        ...
        this._staticGroup.add(mount, probeBody, tip, cable, tempProbe, tempLabel, labelTxt);
    }
    ...
    _drawInstrumentHead() {
        ...
        this._staticGroup.add(jbox, terminals, body, this._idText);
    }
    ...
    _drawLCD() {
        ...
        this._staticGroup.add(lcdBg, this._salinityMain, this._unitLabel, this._currentLabel, this._led);
    }
    ...
    _drawTempPanel() {
        ...
        this._staticGroup.add(panel, this._tempValue, this._condValue, this._flowValue);
    }
    ...
    _drawBottomPanel() {
        ...
        this._staticGroup.add(bg, this._alarmStatus, this._setpointLabel, 
