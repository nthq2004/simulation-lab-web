...
export class ThermalRelay extends BaseComponent {
    ...
    _init() {
        ...
        this._staticGroup.add(this._heaterGroup);
        this._staticGroup.add(this._bimetalGroup);
        this._staticGroup.add(this._leverGroup);
        this._staticGroup.add(this._contactGroup);
        this._staticGroup.add(this._resetGroup);
        this._staticGroup.add(this._barGroup);
