...
export class TimeRelay extends BaseComponent {
    ...
    _init() {
        ...
        this._staticGroup.add(this._displayGroup);
        this._staticGroup.add(this._dialGroup);
        this._staticGroup.add(this._modeLEDGroup);
        this._staticGroup.add(this._seqGroup);
    ...
    _drawBody() {
        ...
        [[b.x + 7, b.y + 7], [b.x + b.w - 7, b.y + 7],
         [b.x + 7, b.y + b.h - 7], [b.x + b.w - 7, b.y + b.h - 7]
            ...
            this._staticGroup.add(new Konva.Circle({ x: sx, y: sy, radius: 3, fill: '#4c5260', stroke: '#2a2e38', strokeWidth: 0.6 }));
            this._staticGroup.add(new Konva.Line({ points: [sx - 1.8, sy - 1.8, sx + 1.8, sy + 1.8], stroke: '#363c48', strokeWidth: 0.8 }));
        });
    ...
    _drawTerminalBlock() {
        ...
        this._terminals.forEach(t => {
            ...
            // 螺钉
            this._staticGroup.add(new Konva.Circle({ x: t.x, y: ty + tH / 2, radius: tW * 0.22, fill: '#8a9298', stroke: '#606870', strokeWidth: 0.5 }));
            this._staticGroup.add(new Konva.Line({ points: [t.x - tW * 0.15, ty + tH / 2, t.x + tW * 0.15, ty + tH / 2], stroke: '#444c58', strokeWidth: 0.8 }));
            // 标注
