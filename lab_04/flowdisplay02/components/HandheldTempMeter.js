...
export class HandheldTempMeter extends BaseComponent {
    ...
    _drawLCD() {
        ...
        this._staticGroup.add(this._mainText);
        ...
        this._staticGroup.add(this._unitText);
        ...
        this._staticGroup.add(this._infoText);
    }
    ...
    _drawProbe() {
        ...
        this._staticGroup.add(this._probeLine);
        ...
        this._staticGroup.add(this._probeTip);
    }
