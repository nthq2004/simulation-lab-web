...
export class KnifeSwitch extends BaseComponent {
    constructor(config, sys) {
        ...
        */
        ...
        this.config ={'label': this.label, 'ratedVoltage': this.ratedVoltage, 'ratedCurrent': this.ratedCurrent, 'initClosed': this._closed, 'animDur': this._animDur};
    ...
    tick(dt) {
        ...
        // 性能优化：稳态（无动画、无电弧）跳过 _rebuildDynamic 和缓存刷新
