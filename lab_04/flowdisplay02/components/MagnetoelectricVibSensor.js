...
export class MagnetoelectricVibSensor extends BaseComponent {
    ...
    _drawCasing() {
        ...
        this._staticGroup.add(casing, cavity);
    }
    ...
    _drawMagnet() {
        ...
        // 磁极标注
        this._staticGroup.add(north, south);
        this._staticGroup.add(new Konva.Text({ x: mX + 25, y: mY + 10, text: 'N', fill: 'white', fontStyle: 'bold' }));
        this._staticGroup.add(new Konva.Text({ x: mX + 25, y: mY + 50, text: 'S', fill: 'white', fontStyle: 'bold' }));
    }
    ...
    _drawCoilSystem() {
        ...
        this._staticGroup.add(this._springTop, this._springBottom, this._movingGroup);
    }
    ...
    _drawStatus() {
        ...
        this._staticGroup.add(this._lcdVal);
    }
