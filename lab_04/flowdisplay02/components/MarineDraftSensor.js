...
export class MarineDraftSensor extends BaseComponent {
    ...
    _drawSea() {
        ...
        this._staticGroup.add(this._seaLevel);
    }
    ...
    _drawSensorBody() {
        ...
        this._staticGroup.add(body, flange, this._diaphragm);
    }
    ...
    _drawLCD() {
        ...
        this._staticGroup.add(bg, this._depthText);
    }
