...
export class MARK6CentralController extends BaseComponent {
    ...
    _drawHeader() {
        ...
        this._staticGroup.add(headerBg, this._titleText, this._sysIdText, 
    ...
    _drawDetectorPanel() {
        ...
        for (let i = 0; i < this.maxDetectors; i++) {
            ...
            this._staticGroup.add(cardBg, nodeLabel, concText, unitText, 
    ...
    _drawTrendChart() {
        ...
        this._staticGroup.add(chartBg, this._trendLine, this._preAlarmLine, this._alarmLine);
    }
    ...
    _drawEventLog() {
        ...
        for (let i = 0; i < 8; i++) {
            ...
            this._staticGroup.add(logText);
        }
        
        this._interactGroup.add(logBg, clearBtn);
    }
    ...
    _drawStatusBar() {
        ...
        this._staticGroup.add(barBg, this._sysStatusLed, this._sysStatusText,
    ...
    _drawConfigButtons() {
        ...
        this._interactGroup.add(settingsBtn);
    }
