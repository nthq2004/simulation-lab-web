...
export class MicrowaveOven extends BaseComponent {
    ...
    _drawDoor() {
        ...
        this._staticGroup.add(this._doorFrame);
        ...
        this._staticGroup.add(this._doorGlass);
        ...
        this._staticGroup.add(this._doorHandle);
    ...
    _drawMagnetronArea() {
        ...
        this._staticGroup.add(this._magnetronIndicator);
    ...
    _drawWaveguide() {
        ...
        this._staticGroup.add(this._stirrerGroup);
    ...
    _drawTurntable() {
        ...
        this._staticGroup.add(this._turntableGroup);
    }
    ...
    _drawFood() {
        ...
        this._staticGroup.add(this._foodGroup);
        ...
        this._staticGroup.add(this._foodTempText);
    }
    ...
    _drawControlPanel() {
        ...
        this._staticGroup.add(this._dispTime);
        ...
        this._staticGroup.add(this._dispStatus);
        ...
        for (let n = 1; n <= 6; n++) {
            ...
            this._interactGroup.add(btn, txt, lbl);
        ...
        this._interactGroup.add(this._startBtn, this._startBtnText);
        ...
        this._interactGroup.add(this._stopBtn, this._stopBtnText);
    ...
    _buildDynamicLayers() {
        ...
        this._staticGroup.add(this._waveGroup);
