...
export class MixerFaucet extends BaseComponent {
    ...
    _drawSpout() {
        ...
        this._staticGroup.add(this._spoutHole);
    }
    ...
    _drawCapBase() {
        ...
        this._staticGroup.add(this._capShape);
    ...
    _buildLeverGroup() {
        ...
        this._staticGroup.add(this._leverGroup);
    }
    ...
    _drawLCDPanel() {
        ...
        this._staticGroup.add(this._lcdUnit);
        ...
        this._staticGroup.add(this._lcdFlowText);
    ...
    _drawParticleLayer() {
        ...
        this._staticGroup.add(this._streamGroup);
    }
