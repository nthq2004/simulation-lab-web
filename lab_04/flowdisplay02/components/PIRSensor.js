...
export class PIRSensor extends BaseComponent {
    ...
    _init() {
        ...
        this._staticGroup.add(this._fovGroup);
        this._staticGroup.add(this._lensInnerGroup);
        this._staticGroup.add(this._crystalGroup);
        this._staticGroup.add(this._fresnelGroup);
        this._staticGroup.add(this._signalGroup);
        this._staticGroup.add(this._outLedGroup);
        this._staticGroup.add(this._glassCapGroup);
    ...
    _bindInteraction() {
        ...
        this._interactGroup.add(hitCircle);
