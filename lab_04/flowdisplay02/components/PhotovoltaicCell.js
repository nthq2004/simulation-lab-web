...
export class PhotovoltaicCell extends BaseComponent {
    ...
    _drawFaceBackground() {
        ...
        this._staticGroup.add(this._arcRect);
    ...
    _drawLightLayer() {
        ...
        this._staticGroup.add(this._lightGroup);
    ...
    _drawCarrierLayer() {
        ...
        this._staticGroup.add(this._carrierGroup);
    ...
    _drawStatusIndicator() {
        ...
        this._staticGroup.add(this._readoutIsc, this._readoutVoc);
    }
