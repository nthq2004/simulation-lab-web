...
export class Pump extends BaseComponent {
    ...
    initMainFrame() {
        ...
        this._staticGroup.add(labelText, this.mainFrame);
    }
    ...
    initControlBox() {
        ...
        this._staticGroup.add(boxPanel);
        ...
        this.btnStart = this.createLightButton({
            ...
            text: '启动',
            fontSize: 16,
            onClick: () => { const pt = this.sys.comps.pt; if (!pt || pt.checkPipesReady())this.pumpOn = true; }
        });
        ...
        this._staticGroup.add(this.btnStart.node, this.btnStop.node);
    }
    ...
    initPumpBody() {
        ...
        this._staticGroup.add(this.pumpGroup);
    }
