...
export class RadarLevelSensor extends BaseComponent {
    ...
    _drawJunctionBox() {
        ...
        this._staticGroup.add(jbox, plate, lcap, rcap, this._idText);
    }
    ...
    _drawAntennaBody() {
        ...
        this._staticGroup.add(body, sheen, horn, hornInner, feed, feedDot);
    }
    ...
    _drawOledDisplay() {
        ...
        this._staticGroup.add(outerRing, midRing, this._oledBg,
    ...
    _drawTank() {
        ...
        this._staticGroup.add(outer, this._tankInner, bottom, this._connLine);
    }
    ...
    _drawBottomPanel() {
        ...
        this._staticGroup.add(new Konva.Text({ x: 10, y: py+29, width: pw/3-10, text: '液位 %', fontSize: 8, fill: '#546e7a', align: 'center' }));
        ...
        this._staticGroup.add(new Konva.Text({ x: pw/3+4, y: py+29, width: pw/3-8, text: '距离 m', fontSize: 8, fill: '#546e7a', align: 'center' }));
        ...
        this._staticGroup.add(new Konva.Text({ x: pw*2/3+4, y: py+29, width: pw/3-8, text: '电流 mA', fontSize: 8, fill: '#546e7a', align: 'center' }));
        ...
        this._staticGroup.add(panelBg, this._dispLevel, this._dispDist,
