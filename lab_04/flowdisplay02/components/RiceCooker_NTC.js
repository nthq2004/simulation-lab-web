...
export class MicroRiceCooker extends BaseComponent {
    ...
    _init() {
        ...
        // 动态层
        this._ntcDynamic   = new Konva.Group(); this._staticGroup.add(this._ntcDynamic);
        this._relayDynamic = new Konva.Group(); this._staticGroup.add(this._relayDynamic);
        this._controlDynamic = new Konva.Group(); this._staticGroup.add(this._controlDynamic);
        this._panelDisplay = new Konva.Group(); this._staticGroup.add(this._panelDisplay);
        this._potDynamic   = new Konva.Group(); this._staticGroup.add(this._potDynamic);
    ...
    _updateHeaterGlow() {
        ...
        if (!this._heaterGlowRect) {
            ...
            this._staticGroup.add(this._heaterGlowRect);
        }
    ...
    _drawPowerSupply() {
        ...
        this._staticGroup.add(new Konva.Text({ x: ps.x+10, y: cy-6, text: 'T1', fontSize: 8, fill: '#ffcc80' }));
        // 整流桥
        this._staticGroup.add(new Konva.Rect({
            x: ps.x+42, y: cy-8, width: 20, height: 16,
            fill: '#202020', stroke: '#404040', strokeWidth: 0.6, cornerRadius: 1,
        }));
        this._staticGroup.add(new Konva.Text({ x: ps.x+46, y: cy-4, text: 'DB', fontSize: 7, fill: '#80a0ff' }));
        // 滤波电容
        this._staticGroup.add(new Konva.Rect({
            x: ps.x+70, y: cy-12, width: 12, height: 20,
            fill: '#102060', stroke: '#2040a0', strokeWidth: 0.6, cornerRadius: 2,
        }));
        this._staticGroup.add(new Konva.Text({ x: ps.x+72, y: cy-6, text: 'C', fontSize: 7, fill: '#8090ff' }));
        // 三端稳压 7805
        this._staticGroup.add(new Konva.Rect({
            x: ps.x+ps.w-22, y: cy-6, width: 16, height: 12,
            fill: '#282828', stroke: '#505050', strokeWidth: 0.5,
        }));
        this._staticGroup.add(new Konva.Text({ x: ps.x+ps.w-20, y: cy-4, text: '7805', fontSize: 6, fill: '#a0c0a0' }));
        ...
        this._staticGroup.add(new Konva.Text({ x: ps.x+ps.w-2, y: cy-6, text: '+5V', fontSize: 6, fill: '#ff8080' }));
    }
    ...
    _drawRelayZone() {
        ...
        this._staticGroup.add(this._relayRect);
        this._staticGroup.add(new Konva.Text({ x: cx-8, y: cy-6, text: 'RELAY', fontSize: 7, fill: '#ffcc80' }));
        // 线圈引脚
        this._staticGroup.add(new Konva.Line({
        ...
        this._staticGroup.add(new Konva.Text({ x: cx-34, y: cy-1, text: 'D', fontSize: 6, fill: '#ff8080' }));
        ...
        if (this.heaterType === 'triac') {
            ...
            this._staticGroup.add(new Konva.Text({ x: cx+25, y: cy-4, text: 'TR', fontSize: 6, fill: '#80a0ff' }));
        }
    }
    ...
    _drawCtrlBoard() {
        ...
        this._staticGroup.add(new Konva.Text({ x: cb.x+10, y: cy-6, text: 'MCU', fontSize: 9, fill: '#60ff60', fontStyle: 'bold' }));
        // 引脚示意
        for (let i = 0; i < 4; i++) {
            this._staticGroup.add(new Konva.Rect({ x: cb.x+4, y: cy-8+i*5, width: 2, height: 3, fill: '#a0a0a0' }));
            this._staticGroup.add(new Konva.Rect({ x: cb.x+36, y: cy-8+i*5, width: 2, height: 3, fill: '#a0a0a0' }));
        }
        ...
        this._staticGroup.add(new Konva.Text({ x: cb.x+38, y: cy-9, text: 'ADC_IN', fontSize: 6, fill: '#40ff40' }));
        ...
        this._staticGroup.add(new Konva.Text({ x: cb.x+38, y: cy-1, text: 'HEAT_CTRL', fontSize: 6, fill: '#ffaa40' }));
        ...
        this._staticGroup.add(new Konva.Text({ x: cb.x+cb.w-18, y: cy-1, text: '4MHz', fontSize: 6, fill: '#a0a0a0' }));
    }
