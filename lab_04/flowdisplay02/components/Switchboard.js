...
export class Switchboard extends BaseComponent {
    constructor(config, sys) {
        ...
        this._staticGroup.add(busLabel);
        ...
        this._staticGroup.add(this.ampText);
        ...
        this._staticGroup.add(this.hzText);
