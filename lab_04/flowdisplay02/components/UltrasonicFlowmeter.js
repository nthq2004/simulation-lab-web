...
export class UltrasonicFlowmeter extends BaseComponent {
    ...
    _drawPipeSection() {
        ...
        this._staticGroup.add(outer, this._flowChannel, topSheen, botSheen);
    }
    ...
    _drawTransducers() {
        ...
        const drawTransducer = (tx, ty, isTop, label) => {
            ...
            this._staticGroup.add(transGroup);
        };
    ...
    _drawSoundPath() {
        ...
        this._staticGroup.add(this._pathLine, this._angleLbl);
    }
    ...
    _drawOscilloscope() {
        ...
        this._staticGroup.add(scrBg, this._oscDtLine, this._oscZeroLine,
    ...
    _drawLCD() {
        ...
        this._staticGroup.add(outer, midRing, this._lcdBg, this._snrArc,
    ...
    _drawBottomPanel() {
        ...
        this._staticGroup.add(bg, this._panelTotal, this._panelDeltaT, this._panelStatus, this._panelCs);
    }
