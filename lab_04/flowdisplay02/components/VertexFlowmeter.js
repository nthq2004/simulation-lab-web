...
export class VortexFlowmeter extends BaseComponent {
    ...
    _drawLabel() {
        ...
        this._staticGroup.add(this._labelNode);
    }
    ...
    _drawPipeSection() {
        ...
        [0.2, 0.5, 0.8].forEach(r => {
            this._staticGroup.add(new Konva.Circle({ x: lfX+7, y: py-8+flangeH*r, radius: 3, fill: '#37474f', stroke: '#263238', strokeWidth: 0.5 }));
        });
        ...
        [0.2, 0.5, 0.8].forEach(r => {
            this._staticGroup.add(new Konva.Circle({ x: rfX+7, y: py-8+flangeH*r, radius: 3, fill: '#37474f', stroke: '#263238', strokeWidth: 0.5 }));
        });
        ...
        this._staticGroup.add(pipeOuter, this._flowChannel, lFlange, rFlange, topSheen);
    }
    ...
    _drawBluffBody() {
        ...
        this._bluffCX = bluffX;
        this._staticGroup.add(bluffBody, topCap, botCap, bluffGlint, bluffLbl, arrowLbl);
    }
    ...
    _drawFlowArrows() {
        ...
        arrowXs.forEach((ax, i) => {
            ...
            this._staticGroup.add(arrow, head);
        });
    }
    ...
    _drawVortexLayer() {
        ...
        this._staticGroup.add(this._vortexGroup, this._particleGroup);
    }
    ...
    _drawSensorProbe() {
        ...
        this._staticGroup.add(probe, needle, this._probeLed, probeLbl);
    }
    ...
    _drawInstrumentHead() {
        ...
        this._staticGroup.add(new Konva.Text({ x: hx+18, y: hy+21, width: hw-36, text: 'VORTEX  4~20mA', fontSize: 7, fill: '#78909c', align: 'center' }));
        ...
        this._staticGroup.add(jbox, lcap, rcap, plate, this._idText, body, bodySheen);
    }
    ...
    _drawLCDDisplay() {
        ...
        this._staticGroup.add(outer, midRing, this._lcdBg, this._freqArc,
    ...
    _drawBottomPanel() {
        ...
        this._staticGroup.add(bg, this._panelTotal, this._panelPulse, this._panelStatus, this._panelVel);
    }
