...
export class IndoorACUnit extends BaseComponent {
    ...
    _drawDrainPan() {
        ...
        this.group.add(this._waterLevel);
    ...
    _drawLouvers() {
        ...
        this.group.add(this._louverGroup);
    }
    ...
    _drawDisplayPanel() {
        ...
        this.group.add(this._displayText);
