...
export class AirBackwashFilter extends BaseComponent {
    ...
    _init() {
        ...
        this.group.add(this._dynFlow, this._dynRotor, this._dynStatus);
    ...
    _drawWiringPanel() {
        ...
        // 开关符号（常开触点）
        this.group.add(new Konva.Line({ points:[sx+2,sy+22, sx+12,sy+22], stroke:'#2a4050', strokeWidth:1.5 }));
        this.group.add(new Konva.Line({ points:[sx+2,sy+22, sx+2,sy+10], stroke:'#2a4050', strokeWidth:1.5 }));
        this.group.add(new Konva.Line({ points:[sx+12,sy+8, sx+12,sy+22], stroke:'#2a4050', strokeWidth:1.5 }));
        this.group.add(new Konva.Line({ points:[sx+12,sy+22, sx+22,sy+22], stroke:'#2a4050', strokeWidth:1.5 }));
        this.group.add(new Konva.Text({ x:sx+4, y:sy-10, text:'S₁', fontSize:9, fontStyle:'bold', fill:'#2a4050' }));

        // 电磁阀符号（矩形线圈）
        const vx = sx, vy = b.y + b.h*0.14;
        this.group.add(new Konva.Rect({ x:vx-2, y:vy, width:28, height:22, fill:'#f0f0f8', stroke:'#8090a0', strokeWidth:1, cornerRadius:2 }));
        this.group.add(new Konva.Text({ x:vx, y:vy+4, text:'SV', fontSize:8, fontStyle:'bold', fill:'#2a4050' }));
        this.group.add(new Konva.Text({ x:sx+4, y:vy-9, text:'P₀', fontSize:8, fill:'#2a4060' }));
    }
    ...
    _drawSectionView() {
        ...
        for (let i = 0; i < n; i++) {
            ...
            // 内部滤网（双圆圈）
            this.group.add(new Konva.Circle({ x:px, y:py, radius:pr*0.65, fill:'transparent', stroke:'#8090a0', strokeWidth:0.7 }));
            this.group.add(new Konva.Circle({ x:px, y:py, radius:pr*0.35, fill:'#6a8090', stroke:'#4a6070', strokeWidth:0.5 }));
        ...
        // 中心轴孔
        this.group.add(new Konva.Circle({ x:cx, y:cy, radius:sr*0.12, fill:'#8090a0', stroke:'#5a6070', strokeWidth:1 }));
        this.group.add(new Konva.Circle({ x:cx, y:cy, radius:sr*0.06, fill:'#3a4858' }));
        ...
        this.group.add(this._sectionArrow);
    ...
    _drawLabel() {
        ...
        annots.forEach(({ x, y, text }) => {
            this.group.add(new Konva.Text({ x, y, text, fontSize: 9, fill: '#3a5060' }));
        });
    }
    ...
    _drawStatusPanel() {
        ...
        this.group.add(this._stateBox, this._stateText, this._motorText, this._solText);
        ...
        this.group.add(this._btnClean, this._btnCleanText, this._btnPause, this._btnPauseText);
