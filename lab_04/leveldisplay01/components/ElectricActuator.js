...
export class ElectricActuator extends BaseComponent {
    ...
    _drawOuterShell() {
        ...
        [[bx+10,by+10],[bx+bw-10,by+10],[bx+10,by+bh-10],[bx+bw-10,by+bh-10]].forEach(([cx,cy])=>{
            this.group.add(new Konva.Circle({ x:cx,y:cy,radius:5,
            ...
            this.group.add(new Konva.Line({ points:[cx-3,cy,cx+3,cy],
    ...
    _drawControlZone() {
        ...
        this.group.add(new Konva.Text({x:mx-mr,y:my+mr*0.55,text:'CLOSE',fontSize:6.5,fill:'#405868',width:mr,align:'center'}));
        this.group.add(new Konva.Text({x:mx,y:my+mr*0.55,text:'OPEN',fontSize:6.5,fill:'#405868',width:mr,align:'center'}));
        ...
        ledDefs.forEach((d,i)=>{
            ...
            this.group.add(new Konva.Circle({x:lx,y:ly,radius:5,
                fillLinearGradientStartPoint:{x:-2,y:-2},fillLinearGradientEndPoint:{x:2,y:2},
                fillLinearGradientColorStops:[0,'#606468',1,'#303438'],
            ...
            this.group.add(new Konva.Text({x:lx+7,y:ly-5,text:d.label,fontSize:7.5,fontStyle:'bold',fill:'#50686a'}));
        });
        ...
        dispItems.forEach((d,i)=>{
            this.group.add(new Konva.Text({x:dispX,y:dispY+i*lineH,text:d.label+':',fontSize:8,fontStyle:'bold',fill:this._darken(d.color,0.2)}));
        ...
        this.group.add(this._ctrlModeText);
        ...
        btnDefs.forEach(({label,x})=>{
            ...
            this.group.add(btn);
            this.group.add(new Konva.Text({x:x-14,y:z.y+z.h*0.782,text:label,
    ...
    _drawMotorZone() {
        ...
        // 转子外圈
        this.group.add(new Konva.Circle({x:cx,y:cy,radius:r*0.48,
            fill:'transparent',stroke:'#506070',strokeWidth:1.0,dash:[3,3]}));

        // 转子铁心
        this.group.add(new Konva.Circle({x:cx,y:cy,radius:r*0.40,
        ...
        // 轴
        this.group.add(new Konva.Circle({x:cx,y:cy,radius:r*0.08,
            fill:'#a0a8b0',stroke:'#707880',strokeWidth:0.6}));

        // 风叶（右侧）
        const fanX=z.x+z.w*0.82, fanY=cy;
        this.group.add(new Konva.Circle({x:fanX,y:fanY,radius:r*0.42,
        ...
        // 参数标注
        this.group.add(new Konva.Text({x:z.x+z.w*0.04,y:z.y+z.h*0.75,
    ...
    _drawGearZone() {
        ...
        stage.forEach(({cx:scx,cy:scy,r:sr,label},si)=>{
            // 齿圈（外环）
            this.group.add(new Konva.Circle({x:scx,y:scy,radius:sr,
            ...
            // 太阳轮
            const sunR=sr*0.22;
            this.group.add(new Konva.Circle({x:scx,y:scy,radius:sunR,
            ...
            for(let i=0;i<3;i++){
                ...
                this.group.add(new Konva.Circle({x:px,y:py,radius:pr,
                ...
                this.group.add(new Konva.Circle({x:px,y:py,radius:2,fill:'#a0b0b8'}));
            }
            // 标注
            this.group.add(new Konva.Text({x:scx-20,y:scy+sr+6,text:label,
                fontSize:7,fill:'#406070',width:40,align:'center'}));
        });

        // 传动比标注
        this.group.add(new Konva.Text({x:z.x+3,y:z.y+z.h*0.88,
    ...
    _drawFeedbackZone() {
        ...
        // 多圈电位器外壳
        this.group.add(new Konva.Circle({x:cx,y:cy,radius:r,
            fillRadialGradientStartPoint:{x:-r*0.2,y:-r*0.2},fillRadialGradientEndPoint:{x:0,y:0},
            fillRadialGradientStartRadius:0,fillRadialGradientEndRadius:r,
            fillRadialGradientColorStops:[0,'#505860',0.6,'#383e48',1,'#282e38'],
            stroke:'#4a5260',strokeWidth:1.2}));
        // 电阻轨道弧
        this.group.add(new Konva.Arc({x:cx,y:cy,innerRadius:r*0.60,outerRadius:r*0.80,
            angle:270,rotation:-225,fill:'#604020',stroke:'#806040',strokeWidth:0.5}));
        // 电位器轴
        this.group.add(new Konva.Circle({x:cx,y:cy,radius:r*0.15,
            fill:'#909898',stroke:'#707878',strokeWidth:0.6}));

        // 4~20mA 变送模块
        const tmX=z.x+z.w*0.42, tmY=z.y+z.h*0.20;
        const tmW=z.w*0.20, tmH=z.h*0.60;
        this.group.add(new Konva.Rect({x:tmX,y:tmY,width:tmW,height:tmH,
            fill:'#1a2830',stroke:'#2a3848',strokeWidth:0.8,cornerRadius:2}));
        this.group.add(new Konva.Text({x:tmX,y:tmY+4,text:'4~20mA\nTX',
            fontSize:7,fill:'#406878',width:tmW,align:'center',lineHeight:1.4}));
        // 芯片
        this.group.add(new Konva.Rect({x:tmX+tmW*0.20,y:tmY+tmH*0.45,
        ...
        this.group.add(this._fbCurrentText);
        this.group.add(new Konva.Text({x:z.x+z.w*0.66,y:z.y+z.h*0.62,
            text:'PV=50.0%',fontSize:9,fontFamily:'monospace',fill:'#20c0ff',
        }));
        this._fbPvText=new Konva.Text({x:z.x+z.w*0.66,y:z.y+z.h*0.62,
            text:'PV= 50.0%',fontSize:9,fontFamily:'monospace',fill:'#20c0ff'});
        // 替换上面的静态文字：
        this.group.add(new Konva.Text({x:z.x+z.w*0.66,y:z.y+z.h*0.78,
    ...
    _drawOutputZone() {
        ...
        // 管道截面（圆环）
        this.group.add(new Konva.Circle({x:cx,y:cy,radius:pipeR,
            fill:'transparent',stroke:'#405870',strokeWidth:pipeR*0.18}));
        // 管道内壁
        this.group.add(new Konva.Circle({x:cx,y:cy,radius:pipeR*0.82,
            fill:'transparent',stroke:'#283848',strokeWidth:1.0}));
        // 管道流体背景
        this.group.add(new Konva.Circle({x:cx,y:cy,radius:pipeR*0.80,
        ...
        // 轴联结法兰
        this.group.add(new Konva.Rect({x:cx-pipeR-8,y:shaftY-8,width:8,height:16,
        ...
        this.group.add(new Konva.Text({x:cx-6,y:cy-pipeR-18,text:'0°',fontSize:7,fill:'#406080',align:'center',width:12}));
        this.group.add(new Konva.Text({x:cx+pipeR+2,y:cy-6,text:'90°',fontSize:7,fill:'#406080'}));
    ...
    _drawTerminalZone() {
        ...
        terms.forEach(({label,x,color,desc})=>{
            const cy=by+bh*0.38;
            this.group.add(new Konva.Circle({x,y:cy,radius:bh*0.20,
            ...
            this.group.add(new Konva.Line({points:[x-3,cy,x+3,cy],
                stroke:'rgba(0,0,0,0.5)',strokeWidth:1,lineCap:'round'}));
            this.group.add(new Konva.Text({x:x-10,y:by+bh*0.62,text:label,
                fontSize:6.5,fontStyle:'bold',fill:'#608090',align:'center',width:20}));
            this.group.add(new Konva.Text({x:x-10,y:by+bh*0.80,text:desc,
    ...
    _drawDynMotor() {
        ...
        this.group.add(this._dynMotorGroup);
    }
    _drawDynGear() {
        this._dynGearGroup=new Konva.Group();
        this.group.add(this._dynGearGroup);
    }
    _drawDynFeedback() {
        this._dynFbGroup=new Konva.Group();
        this.group.add(this._dynFbGroup);
    }
    _drawDynOutput() {
        this._dynOutGroup=new Konva.Group();
        this.group.add(this._dynOutGroup);
    }
    _drawDynControl() {
        this._dynCtrlGroup=new Konva.Group();
        this.group.add(this._dynCtrlGroup);
        this._rebuildCtrlDynamic();
    }
    _drawDynProtection() {
        this._dynProtGroup=new Konva.Group();
        this.group.add(this._dynProtGroup);
    }
