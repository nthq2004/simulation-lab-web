...
export class FloatTapeLevelGauge extends BaseComponent {
    ...
    _drawFloat() {
        ...
        this.group.add(this._floatGroup, this._floatLimLine);
    }
    ...
    _drawWeight() {
        ...
        this.group.add(this._weightGroup);
    }
    ...
    _drawTape() {
        ...
        this.group.add(this._tapeTopArc);
    ...
    _drawPulleys() {
        ...
        this.group.add(this._pulleyLeftGrp);
        ...
        this.group.add(this._pulleyRightGrp);
    ...
    _drawSprocket() {
        ...
        this.group.add(this._sprocketGrp);
    ...
    _drawMagneticCoupling() {
        ...
        this.group.add(this._couplingGrp);
    ...
    _drawCounter() {
        ...
        this.group.add(this._counterGroup);
    }
    ...
    _drawDigitalDisplay() {
        ...
        this.group.add(this._lcdBg, this._lcdPct, this._lcdAlarm);
    }
