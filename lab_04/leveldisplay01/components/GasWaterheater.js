...
export class GasWaterHeater extends BaseComponent {
    ...
    _init() {
        ...
        this._flameGroup  = new Konva.Group(); this.group.add(this._flameGroup);
        this._sparkGroup  = new Konva.Group(); this.group.add(this._sparkGroup);
        this._flowGroup   = new Konva.Group(); this.group.add(this._flowGroup);
        this._valveGroup  = new Konva.Group(); this.group.add(this._valveGroup);
        this._sensorGroup = new Konva.Group(); this.group.add(this._sensorGroup);
        this._panelDynGroup = new Konva.Group(); this.group.add(this._panelDynGroup);
        this._fanGroup    = new Konva.Group(); this.group.add(this._fanGroup);
    ...
    _drawGasValveStatic() {
        ...
        this.group.add(new Konva.Text({ x:mx+2, y:my+7, text:'主阀', fontSize:8, fill:'#808080' }));
        ...
        this.group.add(new Konva.Text({ x:px+2, y:py+8, text:'比例\n阀', fontSize:7, fill:'#909090', lineHeight:1.4 }));
        ...
        this.group.add(new Konva.Text({ x:itx+2, y:ity+6, text:'点火\n变压器', fontSize:7.5, fill:'#6060c0', lineHeight:1.5 }));
        // 高压输出线
        this.group.add(new Konva.Line({
    ...
    _drawControlBoard() {
        ...
        this.group.add(new Konva.Text({ x:cz.x+6, y:cz.y+19, text:'MCU', fontSize:8, fill:'#4090e0', fontStyle:'bold' }));
        // 各信号接口标注
        ...
        this.group.add(this._ctrlStatusText);
    }
