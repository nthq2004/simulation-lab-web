...
export class HairDryer extends BaseComponent {
    ...
    _drawIntake() {
        ...
        this.group.add(new Konva.Text({ x: i.x+2, y: i.y-6, text: '进风', fontSize: 7, fill: '#606060' }));
    }
    ...
    _drawOutlet() {
        ...
        this.group.add(new Konva.Text({ x: o.x+o.w-12, y: o.y-6, text: '出风', fontSize: 7, fill: '#606060' }));
    }
    ...
    _drawMotorStatic() {
        ...
        this.group.add(new Konva.Text({ x: cx-8, y: cy-4, text: 'M', fontSize: 10, fill: '#a0c0e0', fontStyle: 'bold' }));
        // 电机轴示意
        this.group.add(new Konva.Line({ points: [cx, cy, cx+15, cy], stroke: '#c0c0c0', strokeWidth: 2 }));
    }
    ...
    _drawHeaterStatic() {
        ...
        this.group.add(new Konva.Text({ x: hz.x+4, y: hz.y-6, text: '电热丝 (Ni-Cr)', fontSize: 7, fill: '#a06020' }));
    }
    ...
    _drawBimetalStatic() {
        ...
        this.group.add(new Konva.Text({ x: bm.x+2, y: bm.y+2, text: '双金属片', fontSize: 6, fill: '#404040' }));
        // 触点示意
        this.group.add(new Konva.Circle({ x: bm.x+bm.w-6, y: bm.y+bm.h/2, radius: 2.5, fill: '#d0a030' }));
        this.group.add(new Konva.Circle({ x: bm.x+bm.w-12, y: bm.y+bm.h/2, radius: 2, fill: '#c0c0c0' }));
    }
    ...
    _drawSwitchPanel() {
        ...
        this.group.add(this._fanSlider, this._fanKnob);
        ...
        this.group.add(this._heatSlider, this._heatKnob);

        // 档位标注
        this.group.add(new Konva.Text({ x: sp.x+5, y: sp.y+2, text: '风速', fontSize: 7, fill: '#c0a060' }));
        this.group.add(new Konva.Text({ x: sp.x+5, y: sp.y+26, text: '温度', fontSize: 7, fill: '#c08060' }));
        this.group.add(new Konva.Text({ x: sp.x+12, y: sp.y+22, text: '○ 低 高', fontSize: 6, fill: '#907050' }));
        this.group.add(new Konva.Text({ x: sp.x+12, y: sp.y+46, text: '○ 低 高', fontSize: 6, fill: '#907050' }));
        ...
        this.group.add(this._powerLed, this._heatLed);
    }
    ...
    _updateDynamicLayers() {
        ...
        if (!this._tempDisplay) {
            ...
            this.group.add(this._tempDisplay);
        }
