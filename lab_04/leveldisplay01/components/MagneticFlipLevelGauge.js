...
export class MagneticFlipLevelGauge extends BaseComponent {
    ...
    _drawScaleRuler() {
        ...
        this.group.add(new Konva.Text({ x: sx + tw , y: hiY - 8, text: 'HH', fontSize: 10, fill: '#ef5350' }));
        this.group.add(new Konva.Text({ x: sx + tw , y: loY + 1, text: 'LL', fontSize: 10, fill: '#ffa726' }));
    ...
    _drawIndicatorColumn() {
        ...
        // 标注
        this.group.add(new Konva.Text({ x: cx-6, y: cy - 18, width: cw+10, text: '翻板柱', fontSize: 10.5, fontStyle: 'bold', fill: '#37474f', align: 'center' }));
    ...
    _drawMainChamber() {
        ...
        // 标注
        this.group.add(new Konva.Text({ x: cx, y: cy - 22, width: cw, text: '主腔', fontSize: 10.5, fontStyle: 'bold', fill: '#37474f', align: 'center' }));
    ...
    _drawTransmitter() {
        ...
        this.group.add(new Konva.Text({ x: tx+2, y: ty+4, width: tw-4, text: '差压变送器', fontSize: 10.5, fontStyle: 'bold', fill: '#12f40e', align: 'center' }));
        ...
        this.group.add(new Konva.Rect({ x: tx+4, y: termY, width: tw-8, height: 46, fill: '#dbe5ef', stroke: '#1a3040', strokeWidth: 1, cornerRadius: 2 }));
    ...
    _drawDrainValve() {
        ...
        this.group.add(new Konva.Text({ x: cx-16, y: cy+16, text: '排污阀', fontSize: 10.5, fill: '#f86307' }));
