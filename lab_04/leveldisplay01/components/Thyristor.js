...
export class Thyristor extends BaseComponent {
    ...
    _drawPnpnOverlay() {
        ...
        this.group.add(this._pnpnOverlayGroup);
    ...
    _drawSchematicSymbol() {
        ...
        // ── 符号标注 A / K / G ──
        this.group.add(new Konva.Text({ x: W * 0.08, y: sy - 12,
            text: 'A', fontSize: 8, fontStyle: 'bold', fill: '#ef9a9a' }));
        this.group.add(new Konva.Text({ x: W * 0.56, y: sy - 12,
            text: 'K', fontSize: 8, fontStyle: 'bold', fill: '#90caf9' }));
        this.group.add(new Konva.Text({ x: W * 0.79, y: sy + r * 1.60,
