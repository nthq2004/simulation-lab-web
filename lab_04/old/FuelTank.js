...
export class FuelTank extends BaseComponent {
    constructor(config, sys) {
        ...
        this._staticGroup.add(this.levelBar);
        ...
        this._staticGroup.add(this.levelFill);
        ...
        this._staticGroup.add(this.levelText);
        ...
        this._staticGroup.add(this.tempText);
