...
export class NakakitaPneumaticPID extends BaseComponent {
    ...
    _drawShell() {
        ...
        [[s.x+12, s.y+10],[s.x+s.w-12, s.y+10],
         [s.x+12, s.y+s.h-10],[s.x+s.w-12, s.y+s.h-10]].forEach(([x,y])=>{
            this._staticGroup.add(new Konva.Circle({ x, y, radius: screwR, fill:'#888', stroke:'#555', strokeWidth:0.6 }));
            this._staticGroup.add(new Konva.Line({ points:[x-screwR*0.65,y,x+screwR*0.65,y], stroke:'#444', strokeWidth:1, lineCap:'round'}));
            this._staticGroup.add(new Konva.Line({ points:[x,y-screwR*0.65,x,y+screwR*0.65], stroke:'#444', strokeWidth:1, lineCap:'round'}));
        });
    ...
    _drawButtonRow() {
        ...
        this._staticGroup.add(this._amDot);
        ...
        this._staticGroup.add(this._amText);
