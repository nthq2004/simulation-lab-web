...
export class OilInWaterSensor extends BaseComponent {
    ...
    _drawProbeCrossSection() {
        ...
        this._staticGroup.add(this._liquidRect);
    ...
    _drawControlUnit() {
        ...
        this._staticGroup.add(this._txBar);
        ...
        this._staticGroup.add(this._rxBar);
        ...
        this._staticGroup.add(this._rxValueText);
    ...
    _drawRelay() {
        ...
        this._staticGroup.add(this._relayArm);
        // 接收触点
        this._staticGroup.add(new Konva.Line({
        ...
        this._staticGroup.add(this._relayStatusText);
    }
    ...
    _drawWaveformScope() {
        ...
        this._staticGroup.add(this._scopeTxLine);
        this._staticGroup.add(this._scopeRxLine);
    }
    ...
    _drawOilSlider() {
        ...
        this._staticGroup.add(this._sliderKnob);
        ...
        this._staticGroup.add(this._oilValueText);
        ...
        this._staticGroup.add(this._alarmText);
