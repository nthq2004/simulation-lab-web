...
export class OxygenSensor extends BaseComponent {
    ...
    _drawPipeSection() {
        ...
        this._staticGroup.add(outer, insulation, this._flowChannel, this._heatOverlay,
                       flangeL, flangeR);
    }
    ...
    _drawGasFlowAnimation() {
        ...
        this._staticGroup.add(this._moleculeGroup);
    }
    ...
    _drawProbeAssembly() {
        ...
        this._staticGroup.add(mount, probeBody, zro2, porousLayer, electrode,
    ...
    _drawAirReference() {
        ...
        this._staticGroup.add(filter, label, arrow);
    }
    ...
    _drawInstrumentHead() {
        ...
        this._staticGroup.add(jbox, body, this._idText);
    }
    ...
    _drawLCD() {
        ...
        this._staticGroup.add(lcdBg, this._oxygenMain, this._unitLabel, this._currentLabel, this._led);
    }
    ...
    _drawHeaterIndicator() {
        ...
        this._staticGroup.add(box, heatBg, this._heatBar, this._heatTempLabel);
    }
    ...
    _drawBottomPanel() {
        ...
        this._staticGroup.add(bg, this._sensorTempLabel, this._nernstLabel,
