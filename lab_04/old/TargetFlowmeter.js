...
export class TargetFlowmeter extends BaseComponent {
    ...
    _drawPipe() {
        ...
        this._staticGroup.add(pipe, arrow);
    }
    ...
    _drawTarget() {
        ...
        this._staticGroup.add(this._targetGroup);
    }
    ...
    _drawElectronicHead() {
        ...
        this._staticGroup.add(casing, cover);
    }
    ...
    _drawLCD() {
        ...
        this._staticGroup.add(lcdBg, this._lcdVal, this._lcdUnit);
    }
