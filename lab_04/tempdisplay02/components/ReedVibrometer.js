...
export class ReedVibrometer extends BaseComponent {
    ...
    _drawShellBack() {
        ...
        this._staticGroup.add(new Konva.Rect({
            ...
            stroke: '#505058', strokeWidth: 1.8,
            cornerRadius: s.rx,
            shadowColor: '#000', shadowBlur: 10,
            shadowOffsetY: 4, shadowOpacity: 0.55,
        }));
    ...
    _drawReed(reed, isResonant) {
        ...
        // 薄片颜色
        const baseColor   = isResonant ? '#f0c040' : '#8090a8';
        ...
        if (isResonant && Math.abs(d) > 0.5) {
            this._dynamicGroup.add(new Konva.Line({
                ...
                listening: false,
                shadowColor: '#ffd040',
                shadowBlur: 8, shadowOpacity: 0.6,
            }));
        }
        ...
        if (segments >= 4) {
            ...
            this._dynamicGroup.add(new Konva.Line({
                points: hlPts,
                stroke: isResonant ? 'rgba(255,240,180,0.50)' : 'rgba(200,210,230,0.25)',
        ...
        this._dynamicGroup.add(new Konva.Circle({
            ...
            strokeWidth: 0.6,
            listening: false,
            shadowColor: isResonant ? '#f0c040' : '#000',
            shadowBlur: isResonant ? 6 : 2,
            shadowOpacity: isResonant ? 0.7 : 0.3,
        }));
    }
    ...
    _drawFreqReadout() {
        ...
        this._dynamicGroup.add(new Konva.Rect({
            ...
            fill: '#080c06',
            stroke: '#203818', strokeWidth: 0.8,
            cornerRadius: 3,
        }));

        let readText = '---';
        let readColor = '#406030';
