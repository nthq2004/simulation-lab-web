...
import { CurrentTransformer } from './export.js';

import { componentConfigs, initSlider } from './project/multimeter_ct.js';
...
export class ControlSystem {
    ...
    showInstrument() {
        ...
        // 仪表配置信息
        const instruments = [
            { id: 'ammeter', name: '电流表', compId: 'ammeter' },
