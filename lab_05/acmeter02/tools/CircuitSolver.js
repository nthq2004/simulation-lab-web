...
export class CircuitSolver {
    ...
    _solve() {
        ...
        // ---总的方程数量。
        const totalSize = mSize + pidEqCount + opAmps.length + oscDevs.length + lvdtDevs.length + aiEqCount + pcEqCount + dcEqCount + aoEqCount + doEqCount + acAmmEqCount + ctEqCount;
        ...
        for (let iter = 0; iter < maxIterations; iter++) {
            ...
            // - 23 交流电流表（0V 电压源注入）
            const acAmmVIdx = totalSize - acAmmEqCount - ctEqCount;
             ...
             */
            const ctVIdx = totalSize - ctEqCount;
