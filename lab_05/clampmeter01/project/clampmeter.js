...
export const PROJECT_WORKFLOWS = {
    'clampmeter-measure': {
        ...
        steps: [
            ...
            {
                msg: '10. 测试：钳形电流表测量小电流的方法',
                mode: 'quiz',
                quizConfig: {
                    question: '用钳形电流表测量小电流时，以下哪种方法可以提高测量精度？',
                    options: [
                        '将导线在钳口上绕几圈，读数除以圈数',
                        '换用更小量程的档位直接测量',
                        '在导线上并联一个电阻',
                    ...
                    answer: 0,
                    analysis: '当被测电流远小于量程时，可将导线在钳口上绕 N 圈，此时读数为实际电流的 N 倍，实际电流 = 读数 / N。这种方法利用了 CT 变比原理（一次绕组匝数从 1 变为 N），相当于放大了信号，提高了测量精度。',
                },
            },
        ],
    },
...
export const componentConfigs = [
    ...
    { Class: Capacitor, id: 'c_load', x: 600, y: 400, capacitance: 100, label: '100μF' },
