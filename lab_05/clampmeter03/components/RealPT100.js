...
/**
 * RealPT100 — 实物风格 PT100 铂电阻传感器组件
 *
 * 说明：
 * - 提供 PT100 的真实外观模型并保存 `temp`、`currentResistance`、`isOpen`/`isShort` 等状态；
 * - 支持 `r0` 扩展（PT1000）与绘制交互，视觉元素加入静态缓存以提升性能。
 */
export class RealPT100 extends BaseComponent {
    ...
    _drawSensorModel() {
        ...
        this._interactGroup.add(wirePath, hexNut, this.probe);
        ...
        this._staticGroup.add(this.resText);
    }
