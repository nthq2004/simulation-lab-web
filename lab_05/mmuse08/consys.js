...
import {
    ...
    Capacitor, JFET, Diode, RealDiode, Zener, RealZener, LED, RealLED, DIAC, RealDIAC, Photodiode, RealPhotodiode, Transistor, NpnTempSensor, RealResistor, SCR, RealScr,
...
import { componentConfigs, initSlider } from './project/multimeter_zener.js';
...
export class ControlSystem {
    ...
    _updatePhysics() {
        ...
        // ── 只有存在电气连线时才运行电路求解器 ──
        // 但有过程校验仪时也运行（校验仪气压显示依赖 InstrumentUpdater）
