...
export class CircuitSolver {
    ...
    _solve() {
        ...
        const {
            ...
            oscDevs, osc3Devs, diodeDevs, zenerDevs, ledDevs, photodiodeDevs, diacDevs, resistorDevs, pressDevs, transmitterDevs,
            ...
            motorDevs, scrDevs, igbtDevs, mosfetDevs,
        } = this._deviceCache;
        ...
        // ---总的方程数量。
        const totalSize = mSize + pidEqCount + opAmps.length + oscDevs.length + lvdtDevs.length + aiEqCount + pcEqCount + dcEqCount + aoEqCount + doEqCount;
    ...
    _updateDeviceCurrents(devices, results) {
        const {
            ...
            diodeDevs, zenerDevs, ledDevs, photodiodeDevs, diacDevs, bjtDevs, jfetDevs, capacitorDevs, inductorDevs,
            oscDevs, lvdtDevs, sgDevs, powerDevs, power3Devs, relayDevs, aiDevs,
            pcDevs, aoDevs, diDevs, doDevs, mf47Devs, ne555Devs, ccDevs,
            scrDevs, igbtDevs, mosfetDevs,
        } = devices;
        // --- 内部辅助：安全获取端口电压 ---
