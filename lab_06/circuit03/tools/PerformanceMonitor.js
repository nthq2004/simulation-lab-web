...
export class PerformanceMonitor {
    constructor() {
        this.metrics = {
            ...
            pneumaticSolve: { count: 0, totalTime: 0, minTime: Infinity, maxTime: 0 },
            digitalSolve: { count: 0, totalTime: 0, minTime: Infinity, maxTime: 0 },
            thermalSolve: { count: 0, totalTime: 0, minTime: Infinity, maxTime: 0 },
            tickAll: { count: 0, totalTime: 0, minTime: Infinity, maxTime: 0 },
        };
        this.enabled = false;
