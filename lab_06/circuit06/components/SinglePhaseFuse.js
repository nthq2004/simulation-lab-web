        ...
        if (this._states[0] === 'ok') {
            ...
            if (solver) {
                ...
                if (cL !== undefined && cT !== undefined) {
                    const vL = solver.nodeVoltages.get(cL) || 0;
                    const vT = solver.nodeVoltages.get(cT) || 0;
                    this.physCurrent = (vL - vT) / 0.01;
                    if (Math.abs(this.physCurrent) > this.ratedCurrent * 1.2) {
                        this.blow(0);
                    }
                }
            }
