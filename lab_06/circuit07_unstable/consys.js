...
import {
    ...
    SyncGenerator3P, Busbar3P, MarineMainsSwitch
} from './export.js';
...
import {
    ...
    DigitMegohmMeter, ThreePhaseMotor, MotorTerminalBox, TsCurveDisplay, InductionMotor,
} from './export.js';
...
import { componentConfigs, initSlider } from './project/device_macb.js';
...
export class ControlSystem {
    ...
    init() {
        ...
        this._hasACSource = Object.values(this.comps).some(c =>
            c.type === 'ac_source' || c.type === 'source_3p' || c.type === 'gen_3p' || c.type === 'signal_generator');
