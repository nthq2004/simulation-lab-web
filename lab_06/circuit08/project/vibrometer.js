...
export const componentConfigs = [
    ...
    // ── 振动测试台（左侧）──
    { Class: VibrationTestBench, id: 'vib-bench', x: 200, y: 100,
      label: 'VTB-01', frequency: 0, amplitude: 0 },

    // ── 机械振动表（右列上）──
    { Class: MechanicalVibrometer, id: 'mech-vm', x: 560, y: 260,
      label: 'VM-101', rangeMax: 0.2 },

    // ── Reed 振动计（右列中）──
    { Class: ReedVibrometer, id: 'reed-vm', x: 880, y: 180,
      label: 'RV-201', freqMin: 10, freqMax: 55, freqStep: 2.5,
      vibFrequency: 0, vibAmplitude: 0 },

    // ── 电子振动仪（右列下）──
    { Class: ElectronicVibrometer, id: 'elec-vm', x: 1230, y: 110,
