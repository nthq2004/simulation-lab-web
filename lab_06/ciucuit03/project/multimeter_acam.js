    ...
    'acam-basic': {
        ...
        steps: [
            ...
            },
            {
                ...
                act() {
                    const ac = this.sys.comps['ac'];
                    if (ac) { ac.voltageRMS = 100; ac.update(); }
                },
                check() {
                    const ac = this.sys.comps['ac'];
                    return ac && Math.abs(ac.voltageRMS - 100) < 10;
                },
            },
            {
                msg: '4. 测试题：电磁系仪表工作原理',
            ...
            },
            {
                ...
                act() {
                    const ac = this.sys.comps['ac'];
                    if (ac) { ac.voltageRMS = 300; ac.update(); }
                },
                check() {
    ...
    'acam-voltage-variation': {
        ...
        steps: [
            ...
            },
            {
                ...
                act() {
                    const ac = this.sys.comps['ac'];
                    if (ac) { ac.voltageRMS = 150; ac.update(); }
                },
                check() {
                    const ac = this.sys.comps['ac'];
                    return ac && Math.abs(ac.voltageRMS - 150) < 10;
                },
            },
            {
                ...
                act() {
                    const ac = this.sys.comps['ac'];
                    if (ac) { ac.voltageRMS = 200; ac.update(); }
                },
                check() {
                    const ac = this.sys.comps['ac'];
                    return ac && Math.abs(ac.voltageRMS - 200) < 10;
                },
            },
            {
                msg: '5. 测试题：电流与电压关系',
...
export const componentConfigs = [
    { Class: ACPower, id: 'ac', x: 10, y: 220, voltageRMS: 220, frequency: 50, isOn: false },
