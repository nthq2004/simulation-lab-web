        ...
        steps: [
            {
                ...
                check() {
                    const ac = this.sys.comps['ac'];
                    return ac && ac.isOn && Math.abs(ac.voltageRMS - 220) < 10;
                },
            },
            {
            ...
            },
            {
                ...
                act() {
                    _setVR1Resistance(this.sys, 5000);
                    const ac = this.sys.comps['ac'];
                    if (ac) { ac.voltageRMS = 250; ac.update(); }
                },
                check() {
                    const ac = this.sys.comps['ac'];
                    const vr1 = this.sys.comps['vr1'];
                    return ac && Math.abs(ac.voltageRMS - 250) < 10
...
export const componentConfigs = [
    { Class: ACPower, id: 'ac', x: 10, y: 20, voltageRMS: 220, frequency: 50, isOn: false },
