...
export const componentConfigs = [
    ...
    // ── 冷却水循环系统组件 ──
    { Class: Engine, id: 'engine-01', x: 220, y: 30,
      label: 'ME-01' },

    { Class: Pump, id: 'pump-01', x: 40, y: 180,
      label: 'P-01' },

    { Class: TeeConnector, id: 'tee-01', x: 30, y: 340,direction:'right' },

    { Class: Rotameter, id: 'rotameter-01', x: 640, y: 320,
      label: 'FI-201', scale: 0.8 },

    { Class: DpFlowIndicator, id: 'dp-flow-01', x: 180, y: 640,
      label: 'FI-101', scale: 0.8 },

    { Class: Cooler, id: 'cooler-01', x: 620, y: 800,
      label: 'CL-01' },

    { Class: ElecValve, id: 'elecValve', x: 1080, y: 620,
      label: 'HV-01' },

    { Class: ImpellerFlowIndicator, id: 'impeller-flow-01', x: 1020, y: 160,
...
export function applyAllPresets() {
    ...
    const conns = [
        ...
        { from: 'tee-01_pipe_u', to: 'rotameter-01_pipe_i', type: 'pipe' },
        { from: 'rotameter-01_pipe_o', to: 'elecValve_pipe_u', type: 'pipe' },
        { from: 'tee-01_pipe_r', to: 'dp-flow-01_pipe_i', type: 'pipe' },
        { from: 'dp-flow-01_pipe_o', to: 'cooler-01_pipe_i', type: 'pipe' },
        { from: 'cooler-01_pipe_o', to: 'elecValve_pipe_l', type: 'pipe' },
        { from: 'elecValve_pipe_r', to: 'impeller-flow-01_pipe_i', type: 'pipe' },
        { from: 'impeller-flow-01_pipe_o', to: 'engine-01_pipe_i', type: 'pipe' },
    ];
