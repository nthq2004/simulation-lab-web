...
export class MainContact extends BaseComponent {
    ...
    constructor(config, sys) {
        ...
        this._contactR = 6;
        const bladeLen = Math.floor(this.height / 2);
        this._contactInY = bladeLen / 2 + 4;
        this._contactOutY = this.height - bladeLen / 2 - 4;
    ...
    tick(dt) {
        ...
        const CLOSED_ANG = 7.5;
        const targetAng = pickup ? -CLOSED_ANG : -22.5;
