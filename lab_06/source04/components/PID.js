 ...
 * - 视图使用 Konva 绘制，状态通过 `this._refreshCache()` 刷新到画布。
 *
...
export class PIDController extends BaseComponent {
    ...
    /**
     * 构建 Konva 静态视觉元素（屏幕、LED、参数框与按键）
     * 这些元素主要绘制在 `_staticGroup` / `scaleGroup` 中，不包含持续变化的动态粒子
     */
    initVisuals() {
