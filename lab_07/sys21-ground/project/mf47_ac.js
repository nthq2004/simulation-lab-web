        ...
        steps: [
            {
                ...
                act() {
                    ...
                    if (src) { src.isOn = true; src.vRms = 12; src.freq = 50; src.update(); }
                },
                check() {
                    const src = this.sys.comps['ac_src'];
                    return src && src.isOn && Math.abs(src.vRms - 12) < 0.1;
                },
            },
            {
            ...
            },
            {
                ...
                act() {
                    const src = this.sys.comps['ac_src'];
                    if (src) { src.vRms = 24; src.update(); }
                },
                check() {
                    const src = this.sys.comps['ac_src'];
                    return src && Math.abs(src.vRms - 24) < 0.1;
                },
            },
            {
                ...
                act() {
                    ...
                    if (src) { src.isOn = true; src.vRms = 12; src.update(); }
                },
                check() {
...
export const componentConfigs = [
    // 1. 桥式整流主电路
    { Class: ACPower, id: 'ac_src', x: 120, y: 90, vRms: 12, freq: 50, isOn: false },
