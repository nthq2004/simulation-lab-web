...
export class BubbleLevelTransmitter extends BaseComponent {
    ...
    _drawBackground() {
        ...
        this._staticGroup.add(this._titleText, this._instrFrame, instrLabel);
    }
    ...
    _drawConstantFlowUnit() {
        ...
        this._staticGroup.add(body, sheen, lbl, springGroup, setLabel);
    }
    ...
    _drawRotameter() {
        ...
        this._staticGroup.add(body, lbl, tubeGlass, this._floatBall, this._floatGlint);
        ...
        this._staticGroup.add(this._rotText);
    }
    ...
    _drawDPTransmitter() {
        ...
        this._staticGroup.add(body, sheen, lbl, outerC, midC,
    ...
    _drawPipingLines() {
        ...
        this._staticGroup.add(this._feedbackLine);
    ...
    _drawLevelDisplay() {
        ...
        this._staticGroup.add(dispBg, this._levelMainTxt, this._levelSubTxt);
    }
    ...
    _setupTankDrag() {
        ...
        this._interactGroup.add(this._tankHitArea);
    }
