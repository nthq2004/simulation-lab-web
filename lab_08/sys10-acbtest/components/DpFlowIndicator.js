...
export class DpFlowIndicator extends BaseComponent {
    constructor(config, sys) {
        ...
        this.addPort(this._termInX,  this._pipeY, 'i',  'pipe', 'in');
        this.addPort(this._termOutX, this._pipeY, 'o', 'pipe', 'out');
    }
    ...
    _drawBackground() {
        ...
        this._staticGroup.add(new Konva.Rect({
            x: 0, y: 0, width: W, height: H * 0.8,
            fill: '#969e94', stroke: '#2c2c34', strokeWidth: 1.5,
            cornerRadius: 7,
    ...
    _drawManifoldValves() {
        ...
        this._staticGroup.add(new Konva.Line({
            ...
            stroke: 'rgba(3, 75, 40, 0.4)', strokeWidth: 3.2, dash: [4,4],
        }));
        this._staticGroup.add(new Konva.Text({
            x: cx - 14, y: y - 14, width: 28,
            text: 'EV', fontSize: 20, fill: 'rgba(3, 79, 23, 0.55)', align: 'center',
        }));
    }
    ...
    _drawValveSymbol(x, y, label, col) {
        this._staticGroup.add(new Konva.Line({
            ...
            stroke: col, strokeWidth: 4.2, lineCap: 'round',
        }));
        this._staticGroup.add(new Konva.Text({
            x: x - 50, y: y -1, width: 40,
            text: label, fontSize: 15.5, fill: col, align: 'center',
        }));
    }
    ...
    _drawScaleTicks() {
        ...
        for (let i = 0; i <= total; i++) {
            ...
            if (isMaj) {
                ...
                const lx  = cx + (r0 + 16) * Math.cos(rad);
                const ly  = cy + (r0 + 16) * Math.sin(rad);
                scaleG.add(new Konva.Text({
                    x: lx - 14, y: ly - 6, width: 28, height: 12,
                    text: qV, fontSize: 12, fontFamily: 'monospace',
        ...
        scaleG.add(new Konva.Text({
            ...
            text: this.unit, fontSize: 16, fontStyle: 'bold', fill: '#7a6020', align: 'center',
        }));
        ...
        scaleG.add(new Konva.Arc({
            ...
            fill: 'rgba(170, 50, 50, 0.16)', stroke: 'rgba(200,40,40,0.22)', strokeWidth: 0.5,
        }));
    ...
    _drawStaticLabels() {
        ...
        this._staticGroup.add(new Konva.Text({
            x: 0, y: -30, width: W,
            text: `${this.label}  差压式流量计  `,
            fontSize: 20, fontStyle: 'bold', fill: '#1a212d', align: 'center',
        }));
    }
    ...
    _initDynamicNodes() {
        ...
        this._nPtrText = new Konva.Text({ x:0, y:0, width:36, text:'', fontSize:16, fontFamily:'monospace', fontStyle:'bold', fill:'#d03020', align:'center', shadowColor:'#fff', shadowBlur:2, shadowOpacity:0.7 });
    ...
    _updatePointer() {
        ...
        const qRead = this.getReading().toFixed(2);
