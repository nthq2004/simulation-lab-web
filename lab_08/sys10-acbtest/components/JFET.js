...
export class JFET extends BaseComponent {
    ...
    initVisuals() {
        ...
        this._staticGroup.add(new Konva.Text({ x: -45, y:  -18, text: 'G', ...lbl }));
        this._staticGroup.add(new Konva.Text({ x:   8, y: -45, text: 'D', ...lbl }));
        this._staticGroup.add(new Konva.Text({ x:   8, y:  35, text: 'S', ...lbl }));
    }
