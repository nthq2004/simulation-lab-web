...
export class OvenSystem extends BaseComponent {
    constructor(config, sys) {
        ...
        this._tickAcc = 0; // 100ms physics accumulator
        this._uiAcc = 0;   // 500ms UI accumulator
    }

    // ═══════════════════════════════════════════════════════════
    // Centralized tick (called by ControlSystem each frame)
    // ═══════════════════════════════════════════════════════════
    tick(dt) {
        // 100ms physics update
        this._tickAcc += dt;
        while (this._tickAcc >= 0.1) {
            this._tickAcc -= 0.1;
            this.update();
    ...
    _drawLCD() {
        ...
        this._staticGroup.add(this._lcdTemp, this._lcdUnit);
    }
