...
export class MainContact extends BaseComponent {
    ...
    showContextMenu(evt) {
        ...
        const isClosed = this.deviceRef ? this.deviceRef.getManualOverride() : false;
        menu.appendChild(createItem(isClosed ? '模拟分闸' : '模拟闭合', () => {
            if (this.deviceRef) this.deviceRef.setManualOverride(!this.deviceRef.getManualOverride());
        }));
