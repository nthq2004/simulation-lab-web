 ...
 */
        ...
        switch (this.mode) {
            ...
            case 'DIODE':
                ...
                if (display < 0.2) {
                    ...
                    prefix = '▶|·))';
                    precision = 3;
                    if (display > 2.5) isOverload = true;
                }
                break;
            case 'RES200':
                unit = 'Ω';
    ...
    tick(dt) {
        ...
        if (mode.startsWith('DCV')) {
            ...
            this.update(this._measureCapacitance(s));
    ...
    _measureCapacitance(s) {
        const vIdx = s.portToCluster.get(`${this.id}_wire_v`);
        const comIdx = s.portToCluster.get(`${this.id}_wire_com`);
