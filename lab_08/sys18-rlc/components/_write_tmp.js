...
const f = 'E:/BaiduSyncdisk/03 教学材料/仿真软件制作/网站/lab_07/sys17-aboard/components/ShorePowerMainSwitch.js';
const c = `import { BaseComponent } from './BaseComponent.js';
...
export class ShorePowerMainSwitch extends BaseComponent {
    constructor(config, sys) {
        super(config, sys);
        this.width  = Math.max(120, config.width  || 140);
        this.height = Math.max(150, config.height || 180);
        this.type    = 'PDB';
    ...
    _recalcGeometry() {
        ...
        this._swTop = H * 0.08; this._swH = H * 0.72; this._swW = W * 0.66;
        ...
        this._handleOffsets = { on: -this._swH * 0.22, off: this._swH * 0.16, trip: 0 };
    ...
    _initParameters(config) {
        this.label = config.label || '\\u5cb8\\u7535\\u4e3b\\u5f00\\u5173';
        this.function = '\\u5cb8\\u7535\\u585e\\u58f3\\u65ad\\u8def\\u5668';
    ...
    _drawStaticParts() { this._drawBox3D(); this._drawWiring(); this._drawSwitch(); this._drawTerminals(); this._drawTitle(); }
    ...
    _drawTerminals(){
        ...
        this._drawTerminal(this._uvPort.a.x,this._uvPort.a.y,'UV','#6a5a28',false);
        this._drawTerminal(this._uvPort.b.x,this._uvPort.b.y,'UV','#6a5a28',false);
    }
    ...
    _drawTitle(){
        ...
        this._staticGroup.add(new Konva.Text({x:this._frame.x+6,y:this._frame.y+22,text:\`In=\${this.ratedCurrent}A  \u5931\u538b\u7ebf\u5708\${this._tripCoilR}\u03a9\`,fontSize:9,fill:'#5a6a7a',listening:false}));
    }

    _createDynamicNodes(){this._handleGroup=this._createHandle();}
    ...
    _updateDynamic(){this._handleGroup.y(this._swMidY+this._curHandleY);}
    ...
    getConfigFields(){
        return [
            {label:'\\u4f4d\\u53f7/\\u540d\\u79f0',key:'label',type:'text'},
            {label:'\\u989d\\u5b9a\\u7535\\u6d41 (A)',key:'ratedCurrent',type:'number'},
            {label:'\\u77ed\\u8def\\u5ef6\\u65f6 (s)',key:'shortDelay',type:'number'},
            {label:'\\u8fc7\\u8f7d\\u7cfb\\u6570 K',key:'overloadK',type:'number'},
            {label:'\\u5931\\u538b\\u7ebf\\u5708\\u7535\\u963b (\\u03a9)',key:'tripCoilR',type:'number'},
            {label:'\\u52a8\\u4f5c\\u65f6\\u95f4 (s)',key:'animDur',type:'number'},
        ];
    }
