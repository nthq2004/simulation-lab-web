...
export class ACAmmeter extends BaseComponent {
    constructor(config, sys) {
        ...
        this.width  = Math.max(this.constructor.minWidth  || 340, config.width  || this.constructor.defaultWidth  || 460);
        this.height = Math.max(this.constructor.minHeight || 200, config.height || this.constructor.defaultHeight || 260);
    ...
    _recalcGeometry() {
        ...
        const tCx = coilCx;
        const tSp = rW * 0.18;
        this._termAp = { x: tCx - tSp * 0.5, y: tY - H * 0.10 };
        this._termAn = { x: tCx + tSp * 0.5, y: tY - H * 0.10 };
