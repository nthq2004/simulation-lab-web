...
export class SinamicsV20 extends BaseComponent {
    ...
    _initParameters(config) {
        ...
        this._pdefs = [
            ...
            { n: 'P0015', name: '连接宏',            unit: '',    min: 0, max: 11, step: 1,   dig: 0, lvl: 1, opts: this._macroOpts() },
            { n: 'P0016', name: '应用宏',            unit: '',    min: 0, max: 30, step: 1,   dig: 0, lvl: 1, opts: this._appMacroOpts() },
            { n: 'P0100', name: '欧洲/北美',         unit: '',    min: 0, max: 2, step: 1,    dig: 0, lvl: 2, opts: { 0: 'kW/50Hz', 1: 'hp/60Hz', 2: 'kW/60Hz' } },
            { n: 'P0304', name: '电机额定电压',      unit: 'V',   min: 0, max: 2000, step: 1, dig: 0, lvl: 2, motor: true },
            { n: 'P0305', name: '电机额定电流',      unit: 'A',   min: 0, max: 1000, step: 0.01, dig: 2, lvl: 2, motor: true },
            { n: 'P0307', name: '电机额定功率',      unit: 'kW',  min: 0, max: 1000, step: 0.01, dig: 2, lvl: 2, motor: true },
            { n: 'P0310', name: '电机额定频率',      unit: 'Hz',  min: 12, max: 550, step: 0.01, dig: 2, lvl: 2, motor: true },
            { n: 'P0311', name: '电机额定转速',      unit: 'rpm', min: 0, max: 40000, step: 1, dig: 0, lvl: 2, motor: true },
            ...
            { n: 'P0810', name: '手/自动切换 CDS位0', unit: '',   min: 0, max: 722.4, step: 0.1, dig: 1, lvl: 2, opts: { 0: '关闭', 722.1: 'DI1', 722.2: 'DI2', 722.3: 'DI3', 722.4: 'DI4' } },
            ...
            { n: 'P1110', name: '禁止负频率给定',    unit: '',    min: 0, max: 1, step: 1,    dig: 0, lvl: 2, opts: { 0: '允许反转', 1: '禁止反转' } },
            { n: 'P1300', name: '控制方式',          unit: '',    min: 0, max: 20, step: 1,   dig: 0, lvl: 2, opts: { 0: '线性 V/f', 1: 'V/f+FCC', 2: '抛物线 V/f', 7: '二次方 V/f' } },
            { n: 'P1310', name: '连续提升',          unit: '%',   min: 0, max: 250, step: 0.1, dig: 1, lvl: 2 },
            ...
            { n: 'P0970', name: '工厂复位',          unit: '',    min: 0, max: 21, step: 1,   dig: 0, lvl: 1, opts: { 0: '不复位', 1: '开始工厂复位', 21: '复位用户默认' } },
        ];

        // 参数值
        this._p = {
            P0003: 1, P0004: 0, P0005: 21, P0010: 0, P0015: 0, P0016: 0, P0100: 0,
            P0304: 400, P0305: 7.5, P0307: 3.5, P0310: 55, P0311: 1460,
            P0700: 1, P0701: 1, P0702: 12, P0703: 9, P0704: 15,
            P0731: 52.2, P0732: 52.3, P0756: 0,
            P0810: 0, P0700_1: 2, P1000_1: 2,
            P1000: 1, P1001: 10, P1002: 25, P1003: 40, P1004: 50,
            P1040: 0, P1080: 0, P1082: 50, P1120: 10, P1121: 10, P1110: 0, P1300: 0, P1310: 50, P2000: 50, P3900: 0, P0970: 0,
        };
        // 出厂默认值快照（P0010=30 且 P0970=1 时用于恢复出厂）
        this._factoryDefaults = { ...this._p };
    ...
    _macroOpts() {
        return {
            0: 'Cn000 工厂默认', 1: 'Cn001 BOP 面板控制', 2: 'Cn002 端子+模拟量',
            3: 'Cn003 固定频率(三位)', 4: 'Cn004 固定频率(二进制)', 5: 'Cn005 模拟量+固定频率',
            6: 'Cn006 外部按钮(MOP)', 7: 'Cn007 外部按钮+模拟量', 8: 'Cn008 PID(模拟量)',
            9: 'Cn009 PID(固定值)', 10: 'Cn010 USS(RS485)', 11: 'Cn011 MODBUS RTU(RS485)',
        };
    }

    /** 各连接宏对应的参数预设（Cn000~Cn011，参照 V20 手册） */
    _macroPreset(cn) {
        const T = {
            0:  { P0700: 1, P1000: 1, P0701: 0, P0702: 0, P0703: 9, P0704: 15, P1001: 10, P1002: 15, P1003: 25, P1004: 50, P1016: 1, P1040: 0, P0731: 52.2, P0732: 52.3 },
            1:  { P0700: 1, P1000: 1, P0701: 0, P0702: 0, P0703: 9, P0704: 15, P0731: 52.2, P0732: 52.3 },
            2:  { P0700: 2, P1000: 2, P0701: 1, P0702: 12, P0703: 9, P0704: 10, P0731: 52.2, P0732: 52.3 },
            3:  { P0700: 2, P1000: 3, P0701: 1, P0702: 15, P0703: 16, P0704: 17, P1001: 10, P1002: 15, P1003: 25, P1016: 1 },
            4:  { P0700: 2, P1000: 3, P0701: 15, P0702: 16, P0703: 17, P0704: 18, P1001: 10, P1002: 15, P1003: 25, P1004: 50, P1016: 2 },
            5:  { P0700: 2, P1000: 23, P0701: 1, P0702: 15, P0703: 16, P0704: 9, P1001: 10, P1002: 15, P1016: 1 },
            6:  { P0700: 2, P1000: 1, P0701: 2, P0702: 1, P0703: 9, P0704: 0, P1040: 0 },
            7:  { P0700: 2, P1000: 2, P0701: 2, P0702: 1, P0703: 9, P0704: 0 },
            8:  { P0700: 2, P1000: 2, P0701: 1, P0702: 9, P0703: 9, P0704: 0 },
            9:  { P0700: 2, P1000: 1, P0701: 1, P0702: 9, P0703: 9, P0704: 0 },
            10: { P0700: 5, P1000: 5, P0701: 0, P0702: 0, P0703: 9, P0704: 0 },
            11: { P0700: 5, P1000: 5, P0701: 0, P0702: 0, P0703: 9, P0704: 0 },
        };
        // 连接宏会取消 DI 手/自动切换（P0810=0），并恢复各 DI 的 P070x 功能
        return Object.assign({ P0810: 0 }, T[cn] || {});
    }

    /** 应用连接宏：一键写入该宏的全部参数预设 */
    applyMacro(cn) {
        cn = Math.max(0, Math.min(11, Math.round(cn)));
        const preset = this._macroPreset(cn);
        Object.keys(preset).forEach(k => { if (this._p[k] !== undefined) this._p[k] = preset[k]; });
        this._p.P0700_1 = 2;   // AUTO 数据集：端子 + 模拟量
        this._p.P1000_1 = 2;
        this._panelRun = false;
        this._tip('已应用连接宏 ' + (this._macroOpts()[cn] || ('Cn' + cn)));
        return cn;
    }
    ...
    _appMacroOpts() {
        return {
            0: 'AP000 工厂默认', 10: 'AP010 简单泵应用', 20: 'AP020 简单风机应用',
            21: 'AP021 压缩机应用', 30: 'AP030 输送机应用',
        };
    }

    /** 各应用宏对应的参数预设（参照 V20 手册 AP 表） */
    _appMacroPreset(v) {
        const T = {
            0:  { P1080: 0,  P1300: 0, P1110: 0, P1310: 50 },   // 工厂默认
            10: { P1080: 15, P1300: 7, P1110: 1, P1310: 50 },   // 泵：最小频率 15Hz、二次方 V/f、禁止反转、连续提升
            20: { P1080: 20, P1300: 7, P1310: 50 },              // 风机：最小频率 20Hz、二次方 V/f
            21: { P1300: 0,  P1310: 50 },                        // 压缩机：线性 V/f
            30: { P1300: 1 },                                    // 输送机：V/f + FCC
        };
        return T[v] || {};
    }
    ...
    /** 应用应用宏：一键写入该宏对应的参数预设 */
    applyAppMacro(v) {
        v = Math.max(0, Math.min(30, Math.round(v)));
        const preset = this._appMacroPreset(v);
        Object.keys(preset).forEach(k => { if (this._p[k] !== undefined) this._p[k] = preset[k]; });
        if (this._p.P1080 > this._p.P1082) this._p.P1082 = this._p.P1080;
        this._tip('已应用应用宏 ' + (this._appMacroOpts()[v] || ('AP' + v)));
        return v;
    }
    ...
    _initState() {
        ...
        this._alarm      = null;
        this._uvCount    = 0;
        this._powered    = false;   // 主电源是否得电（决定面板是否点亮/是否工作）
        ...
        this._ui = { mode: 'status', sel: 'P0304', editVal: 0, editDigit: 0, t: 0, setup: { idx: 0, val: 0 } };
        this._blinkOn = true;
        this._mLongFired = false;
        this._mTimer = null;
        // 快速调试（长按 M 进入）参数序列
        this._setupSteps = ['P0100', 'P0304', 'P0305', 'P0307', 'P0310', 'P0311', 'P0015', 'P0016'];
    }
    ...
    _init() {
        ...
        this._registerTerminalParts();
    }

    /** 端子识别热区（逐个端子，供工作流自动演示箭头/圆圈精确指向） */
    _registerTerminalParts() {
        const reg = (id, ax, y) => this.addClickablePart('term-' + id, ax - 14, y - 16, 28, 32);
        this._powerIn.forEach(t => reg(t.id, t.ax, 0));
        this._motorOut.forEach(t => reg(t.id, t.ax, this.height));
        [...this._ctrlRow1, ...this._ctrlRow2].forEach(t => reg(t.id, t.ax, t.y));
    }
    ...
    _drawWarning() {
        ...
        this._staticGroup.add(new Konva.Text({
            x: w.x + 4, y: w.y + w.h * 0.24, width: w.w - 8,
            text: '危险\n断电 5 分钟后\n方可开盖',
    ...
    _drawTerminalStrip() {
        ...
        this._staticGroup.add(new Konva.Text({
            ...
            fontSize: Math.max(11, W * 0.03), fontStyle: 'bold',
        ...
        [...this._ctrlRow1, ...this._ctrlRow2].forEach(tm => {
            ...
            this._staticGroup.add(new Konva.Text({
                ...
                text: tm.label, fontSize: Math.max(11, W * 0.03), fontStyle: 'bold',
    ...
    _drawPowerTerminals() {
        ...
        this._powerIn.forEach(t => {
            ...
            this._staticGroup.add(new Konva.Text({
                ...
                fontSize: Math.max(12, W * 0.032), fontStyle: 'bold',
        ...
        this._motorOut.forEach(t => {
            this._staticGroup.add(new Konva.Rect({
                x: t.x - 7, y: H - 8, width: 14, height: 12, cornerRadius: 1.5,
                fill: '#9aa1a8', stroke: '#565c62', strokeWidth: 0.6, listening: false,
            }));
            this._staticGroup.add(new Konva.Text({
    ...
    _createDynamicNodes() {
        ...
        this._lcdSub = new Konva.Text({
            ...
            text: '', fontSize: Math.max(11, W * 0.042),
        ...
        this._dirText = new Konva.Text({
            ...
            fontSize: Math.max(11, W * 0.034), fontStyle: 'bold',
    ...
    _bindInteraction() {
        ...
        // M 键：短按=参数菜单；长按约 2s=进入快速调试
        const mHit = addBtn('btn-m', this._btnM, 'm');
        if (mHit) {
            mHit.on('mousedown touchstart', () => {
                this._mLongFired = false;
                clearTimeout(this._mTimer);
                this._mTimer = setTimeout(() => { this._mLongFired = true; this._enterSetup(); }, 2000);
            });
            const cancel = () => { clearTimeout(this._mTimer); this._mTimer = null; };
            mHit.on('mouseup touchend mouseleave', cancel);
        }
    }
    ...
    _bopPress(key) {
        ...
        // 长按 M 已触发快速调试：忽略随后的 click
        if (key === 'm' && this._mLongFired) { this._mLongFired = false; return; }
        ...
        switch (key) {
            case 'i':
                if (this._effectiveCmdSource() === 1) { this._panelRun = true; this._tip('BOP 启动命令'); }
                else this._tip('当前为外部（端子）控制，面板启动无效');
                break;
            case 'o':
                this._panelRun = false;
    ...
    _navM() {
        ...
        if (m === 'setup') { this._ui.mode = 'status'; this._tip('退出快速调试'); }
        else if (m === 'list') this._ui.mode = 'status';
    ...
    _navOK() {
        const m = this._ui.mode;
        if (m === 'setup') {
            const num = this._setupSteps[this._ui.setup.idx];
            this.setParam(num, this._ui.setup.val);
            if (this._ui.setup.idx >= this._setupSteps.length - 1) {
                this._ui.mode = 'status';
                this._tip('快速调试完成');
            } else {
                this._ui.setup.idx++;
                this._ui.setup.val = this._p[this._setupSteps[this._ui.setup.idx]];
            }
        }
        else if (m === 'list') this._ui.mode = 'value';
        else if (m === 'value') { this._ui.mode = 'edit'; this._ui.editVal = this._p[this._ui.sel]; this._ui.editDigit = 0; }
        else if (m === 'edit') {
            const def = this._pdef(this._ui.sel);
            if (def.opts) { this.setParam(this._ui.sel, this._ui.editVal); this._ui.mode = 'value'; }
            else if (this._ui.editDigit < this._maxDigit(def, this._ui.editVal)) { this._ui.editDigit++; }  // 移到下一位
            else { this.setParam(this._ui.sel, this._ui.editVal); this._ui.mode = 'value'; }                 // 末位：保存
        }
    }
    ...
    _navUp() {
        if (this._ui.mode === 'setup') {
            const d = this._pdef(this._setupSteps[this._ui.setup.idx]);
            this._ui.setup.val = this._stepEditValue(d, this._ui.setup.val, +1);
        }
        else if (this._ui.mode === 'edit') {
            const def = this._pdef(this._ui.sel);
            this._ui.editVal = def.opts
                ? this._stepEditValue(def, this._ui.editVal, +1)
                : this._changeDigit(def, this._ui.editVal, this._ui.editDigit, +1);
        }
        else this._moveSel(+1);   // ▲ 增大：选下一个（编号更大）参数
    }
    ...
    _navDown() {
        ...
        else this._moveSel(-1);   // ▼ 减小：选上一个（编号更小）参数
    }

    /** 长按 M 进入快速调试（快速设置菜单） */
    _enterSetup() {
        if (!this._powered) return;
        if (this._ui.mode !== 'status') return;
        if (this._fault) { this.acknowledgeFault(); return; }
        this._ui.mode = 'setup';
        this._ui.setup.idx = 0;
        this._ui.setup.val = this._p[this._setupSteps[0]];
        this._tip('进入快速调试');
    }

    /** 恢复出厂设置（P0010=30 且 P0970=1） */
    _factoryReset() {
        Object.keys(this._factoryDefaults).forEach(k => { this._p[k] = this._factoryDefaults[k]; });
        this._panelRun = false;
        this._fOut = 0; this._outputActive = false; this.isOn = false;
        this._fault = null; this._uvCount = 0;
        this._ui.mode = 'status';
        this._p.P0970 = 0;
        this._tip('已恢复出厂设置');
    }
    ...
    /**
     * 编辑态步进：带 opts 的枚举参数在合法取值间循环（如 P0810: 0/722.1/722.2/722.3/722.4），
     * 普通参数按 step 递增/递减并限幅。
     */
    _stepEditValue(def, cur, dir) {
        if (def.opts) {
            const keys = Object.keys(def.opts).map(Number).sort((a, b) => a - b);
            let i = keys.findIndex(k => Math.abs(k - cur) < 1e-6);
            if (i < 0) i = 0;
            i = (i + dir + keys.length) % keys.length;
            return keys[i];
        }
        return this._clampVal(def.n, cur + dir * def.step);
    }
    ...
    _visibleParams() {
        ...
        const qc = this._p.P0010 === 1;   // 快速调试中：显示电机参数
        return this._pdefs.filter(d => d.lvl <= lvl || (qc && d.motor));
    }

    // ── 数值参数：逐位编辑（仿真实 V20 的 digit-by-digit）──
    _maxDigit(def, value) {
        const s = Math.abs(value).toFixed(def.dig).replace('.', '');
        return Math.max(0, s.length - 1);
    }
    _digitAt(value, def, pos) {
        const f = Math.pow(10, def.dig);
        const total = Math.round(Math.abs(value) * f);
        return Math.floor(total / Math.pow(10, pos)) % 10;
    }
    _changeDigit(def, value, pos, dir) {
        const f = Math.pow(10, def.dig);
        const total = Math.round(value * f);
        const p = Math.pow(10, pos);
        const digit = Math.floor(Math.abs(total) / p) % 10;
        let nd = digit + dir;
        if (nd > 9) nd = 0; else if (nd < 0) nd = 9;
        const sign = total < 0 ? -1 : 1;
        const newTotal = sign * (Math.abs(total) + (nd - digit) * p);
        return this._clampVal(def.n, newTotal / f);
    }
    ...
    setParam(num, val) {
        ...
        if (num === 'P0015') {
            this.applyMacro(val);
            return this._p.P0015;
        }

        // 应用宏：一键写入该宏对应的参数预设
        if (num === 'P0016') {
            this.applyAppMacro(val);
            return this._p.P0016;
        }

        // P3900 结束快速调试：结束并（此处仅提示）触发电机数据计算，同时退出快速调试
        if (num === 'P3900' && val !== 0) {
            this._p.P0010 = 0;
            this._tip('快速调试结束，已触发电机数据计算');
        }

        // P0970 工厂复位：需先将 P0010 设为 30
        if (num === 'P0970') {
            if (val !== 0) {
                if (this._p.P0010 !== 30) this._tip('请先设置 P0010=30，再执行 P0970=1');
                else this._factoryReset();
            }
            return this._p.P0970;
        }
    ...
    /** P0810 指定的 DI 序号（0~3），未指定返回 -1 */
    _cdsDiIndex() {
        const m = this._p.P0810;
        if (m >= 722.1 && m <= 722.4) return Math.round((m - 722) * 10) - 1;
        return -1;
    }

    /** P0810 是否由 DI 选择手/自动 */
    _cdsByDi() {
        const i = this._cdsDiIndex();
        return i >= 0 && i < 4;
    }

    /** 当前是否为 AUTO（端子远程控制）：由 P0810 指定的 DI 决定；未指定时按 P0700 */
    _cdsAuto() {
        if (this._cdsByDi()) return !!this._di[this._cdsDiIndex()];
        return this._p.P0700 === 2 || this._p.P0700 === 5;
    }

    /** 是否 HAND（面板）控制方式 */
    handMode() { return !this._cdsAuto(); }

    /**
     * 有效命令源 / 频率设定源：
     *   - P0810 指定了 DI（CDS 手/自动切换）时，按 DI 状态在 CDS0(P0700/P1000) 与 CDS1(P0700_1/P1000_1) 间选择；
     *   - P0810=0（未指定）时，直接使用 P0700 / P1000（面板参数菜单所设即为准）。
     */
    _effectiveCmdSource() {
        if (this._cdsByDi()) return this._cdsAuto() ? (this._p.P0700_1 !== undefined ? this._p.P0700_1 : 2) : this._p.P0700;
        return this._p.P0700;
    }
    _effectiveSetSource() {
        if (this._cdsByDi()) return this._cdsAuto() ? (this._p.P1000_1 !== undefined ? this._p.P1000_1 : 2) : this._p.P1000;
        return this._p.P1000;
    }

    /** 手动/自动切换：HAND = 面板 + MOP，AUTO = 端子 + 模拟量（对应典型宏 Cn001/Cn002） */
    toggleHandAuto() {
        const i = this._cdsDiIndex();
        if (i >= 0) { this._tip(`手/自动由 DI${i + 1} 控制（P0810=${this._p.P0810}）`); return; }
        if (this._p.P0700 === 1) {
    ...
    _readInputs() {
        ...
        this._inputPresent = this._inputWired && this._inputPeak > 120;   // 母线电压正常（可运行）
        this._powered      = this._inputWired && this._inputPeak > 60;    // 控制电源存在（面板点亮）
        this._vdc = this._powered ? Math.max(0, 1.35 * (this._inputPeak / Math.SQRT2)) : 0;
    }
    ...
    _updateControl(dt) {
        ...
        // ── 命令与设定 ─────────────────────────────────────────────
        const cmdSrc = this._effectiveCmdSource();
        const setSrc = this._effectiveSetSource();
        const cdsDi = this._cdsDiIndex();     // 被 P0810 占用为手/自动切换的 DI（不再执行其 P070x 功能）
        ...
        if (p.P1110 === 1) cmdRev = false;   // P1110=1 禁止反转
        ...
        if (this._powered && !this._inputPresent && Math.abs(this._fOut) > 0.1) this._uvCount++;
    ...
    _updateDisplay() {
        ...
        if (this._fault) {
            ...
            unit = d.unit;
            sub = d.opts ? ('编辑 ' + d.n) : ('编辑 ' + d.n + ` 第${this._ui.editDigit + 1}位`);
            color = '#ffe08a';
        } else if (this._ui.mode === 'setup') {
            const d = this._pdef(this._setupSteps[this._ui.setup.idx]);
            main = this._fmtVal(d, this._ui.setup.val);
            unit = d.unit;
            sub = `快速调试 ${this._ui.setup.idx + 1}/${this._setupSteps.length} ${d.name}`;
            color = '#ffe08a';
        }
    ...
    getConfigFields() {
        ...
        return [
            ...
            { label: '连接宏 P0015（一键预设）', key: 'p0015', type: 'select',
              get: c => c._p.P0015,
              options: [
                { label: 'Cn000 工厂默认', value: 0 },
                { label: 'Cn001 BOP 面板控制', value: 1 },
                { label: 'Cn002 端子控制 + 模拟量给定', value: 2 },
                { label: 'Cn003 固定频率（三位）', value: 3 },
                { label: 'Cn004 固定频率（二进制）', value: 4 },
                { label: 'Cn005 模拟量 + 固定频率', value: 5 },
                { label: 'Cn006 外部按钮控制（MOP）', value: 6 },
                { label: 'Cn007 外部按钮 + 模拟量给定', value: 7 },
                { label: 'Cn008 PID 控制（模拟量）', value: 8 },
                { label: 'Cn009 PID 控制（固定值）', value: 9 },
                { label: 'Cn010 USS 控制（RS485）', value: 10 },
                { label: 'Cn011 MODBUS RTU 控制（RS485）', value: 11 },
              ] },
            { label: '应用宏 P0016（一键预设）', key: 'p0016', type: 'select',
              get: c => c._p.P0016,
              options: [
                { label: 'AP000 工厂默认', value: 0 },
                { label: 'AP010 简单泵应用', value: 10 },
                { label: 'AP020 简单风机应用', value: 20 },
                { label: 'AP021 压缩机应用', value: 21 },
                { label: 'AP030 输送机应用', value: 30 },
              ] },
            { label: '手/自动切换源 P0810', key: 'p0810', type: 'select',
              get: c => c._p.P0810,
              options: [
                { label: '关闭（由 P0700 决定）', value: 0 },
                { label: 'DI1', value: 722.1 },
                { label: 'DI2', value: 722.2 },
                { label: 'DI3', value: 722.3 },
                { label: 'DI4', value: 722.4 },
              ] },
    ...
    onConfigUpdate(cfg) {
        ...
        if (cfg.p0810 !== undefined) this.setParam('P0810', cfg.p0810);
        if (cfg.p0015 !== undefined) this.setParam('P0015', cfg.p0015);
        if (cfg.p0016 !== undefined) this.setParam('P0016', cfg.p0016);
