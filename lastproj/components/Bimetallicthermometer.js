...
export class BimetallicThermometer extends BaseComponent {
    ...
    _init() {
        ...
        this.group.add(this._pointerGroup);
    ...
    _drawGlass() {
        ...
        this.group.add(this._glassNode);
        ...
        this.group.add(this._glassHighlight1);
    ...
    _rebuildCoil() {
        ...
        // 螺旋线参数
        const turns    = 5.5;           // 圈数
        const rMin     = r * 0.08;      // 最内圈半径
        const rMax     = r * 0.38;      // 最外圈半径
        const coilCX   = cx;
    ...
    _drawStatusPanel() {
        ...
        this._statusPanelGroup.add(new Konva.Rect({
            x: 8, y: 0, width: W - 16, height: 54,
            fill: '#0d1018', stroke: '#1a2430',
