...
export class ControlSystem {
    ...
    init() {
        ...
        const componentConfigs = [
            ...
            // ── Brokaw 温度传感器 ──
            { Class: DCPower, id: 'b_vcc', x: 200, y: 130, voltage: 15 },
            { Class: NpnTempSensor, id: 'b_q1', x: 400, y: 400, areaRatio: 1 },
            { Class: NpnTempSensor, id: 'b_q2', x: 550, y: 400, areaRatio: 8 },
            { Class: Resistor, id: 'b_r1', x: 580, y: 520, value: 360, direction: 'vertical' },
            ...
            { Class: NpnTempSensor, id: 'b_q3', x: 1100, y: 400, areaRatio: 1 },
            { Class: Resistor, id: 'b_r4', x: 1140, y: 520, value: 1000, direction: 'vertical' },
            { Class: Ground, id: 'b_gnd1', x: 400, y: 600 },
            { Class: Ground, id: 'b_gnd2', x: 600, y: 600 },
            { Class: Ground, id: 'b_gnd3', x: 1140, y: 600 },
            { Class: Ground, id: 'b_gnd4', x: 200, y: 600 },
    ...
    _switchProject(projectId) {
        ...
        // 默认显示所有 Brokaw 组件
        const brokawIds = ['b_vcc', 'b_q1', 'b_q2', 'b_r1', 'b_r2', 'b_r3', 'b_u1', 'b_q3', 'b_r4',
             'b_gnd1', 'b_gnd2', 'b_gnd3', 'b_gnd4', 'multimeter'];
