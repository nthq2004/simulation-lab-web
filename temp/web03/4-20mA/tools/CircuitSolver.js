...
export class CircuitSolver {
    ...
    update() {
        ...
        try {
            ...
            for (let i = 0; i < this.rawDevices.length; i++) {
                ...
                if (d.type === 'resistor') resistSignatures.push(`${d.id}:${d.currentResistance || 0}`);
            }
    ...
    _solve() {
        ...
        //2.处理电源和PID设备、放大器、BJT (使用上面缓存的数组)
